   ...
   #define VORFORM_IST_OPT_ITER_MAX 50
   ...
   {
      struct Def_APW_OUIA     dh_luft_AW; 
      struct Def_APW_IA       dh_luft_ges;
      struct Def_APW_INT_IA   Merker_Vollkontakt;
      struct Def_APW_INT_OUIA Merker_Kontakt;
   };

   struct Def_AW_Geo_profiliert
   {
      double dx_Ecke_Profil_innen;
      double dx_Breite_Profil;
   ...
   struct Def_Zwischenform_Iter
   {
      ...
      struct   Def_APW_OUIA   delh_werte_Z;
      struct   Def_APW_OUIA   dels_werte_Z;
