   ...
   struct Def_Ein_Puff
   {
      ...
      struct   Def_Form ist_vorform;              // Ist  Vorform
      struct   Def_Vol_WP soll_walzform_Vol_WP;   // Soll Walzform Volumen
      ...
      struct   Def_APW_OUIA   dy_awou_p;

      struct   Def_APW_OUIA   dhWP_VS;
