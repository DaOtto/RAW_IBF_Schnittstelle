                        ...
                        )
{
  ...
  /* Ist-Achsenpositionen  */ 
    ...
    Ist_Inter->Werkzeug.Ringumdrehung  = Ist_Inter->da /
    ...
    Ist_Inter->Ibf_Achse1 = Ein_Onli.Ibf_actual.Ibf_Achse1;     /* Messachse IBF 1 [mm] */
    Ist_Inter->Ibf_Achse2 = Ein_Onli.Ibf_actual.Ibf_Achse2;     /* Messachse IBF 2 [mm] */
               ...
               switch (Ist_IBF.InitAchse) 
                 ...
                 case 'x':
                  ...
                  case 'a':  /* Positionieren des Radialschlittens && Position des Axialschlittens über Ringhöhe, um vorzeitiges Aufsetzen zu vermeiden */	
                            ...
                            Soll_IBF->ASO_Pos = Soll_IBF->ASO_Pos_Start + 10.0F;
