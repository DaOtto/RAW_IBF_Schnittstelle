 ...
 * soll. Diese Information befindet sich im Flag \link Radial_Flex_Prof.Profilflag \endlink . Die moeglichen Verlaeufe
 * sind kontinuierlicher Vorschub (\link Radial_Flex_Prof.Profilflag \endlink = 11), diskontinuierlicher Vorschub (\link Radial_Flex_Prof.Profilflag \endlink
 * = 12) und ein Vorschub nach 'Ingo Cr-Berechnung' (\link Radial_Flex_Prof.Profilflag \endlink = 15). Welcher Vorschub
 * verwendet wird, wird in \link Radial_Flex_Prof.Schalter_Kont_DisKo \endlink festgelegt. </p>
 ...
 *@param[in] *Soll_Inter ein Zeiger auf eine Struktur vom Typ \link Def_Soll_Inter \endlink
