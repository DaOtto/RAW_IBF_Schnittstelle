 ...
 // Axialschlitten 
  ...
  case 41: //
   ...
   case 76:    
    ...
    case 102:    
        strncpy(TestString, "Axialprofilieren-Positionen und Flags", SizeString);
        TestDat[1] = (long) Ist_IBF.Profilflag;  										   //konstantes Epsilon 
        TestDat[2] = (long) Ist_IBF.Axial.Profilflag;    									   //Zeit Ringumdrehung
        TestDat[3] = (long) Ist_IBF.InitAchse;													   				
        TestDat[4] = Ist_IBF.AG_Pos;  												   //Soll-Geschw. Dorn
        TestDat[5] = Ist_IBF.ASO_Pos;											   //Ist-Geschw. Dorn
        TestDat[6] = Ist_IBF.ZAR_Pos;
        TestDat[7] = Ist_IBF.ZAL_Pos; 
        TestDat[8] = Ist_IBF.RS_Pos;
        TestDat[9] = 0;
        break;

		/* importiert aus RWTH_V109 */
	case 107:
