#line 1 "C:\\rm3dev\\wagner\\raw\\RWTH_SMP\\RWTH_V109\\RWTH_SMP.bd\\source\\ibf_dw_regelung.cpp"
...
#line 2 "C:\\rm3dev\\wagner\\raw\\RWTH_SMP\\RWTH_V109\\RWTH_SMP.bd\\source\\ibf_dw_regelung.cpp"
                                 ...
                                 struct Def_IBF_Allgemein_SOLL *Soll_IBF)
{
     ...
     ri_block1 = Ist_IBF.DW_Regelung.Abstand_C - Soll_IBF->DW_Regelung.Messwert_A_mf * 0.64F;

 
   

     ri_block2 = Ist_IBF.AG_Pos + Ist_IBF.DW_Regelung.Offset - 0.5 * Ist_IBF.da  
                - Soll_IBF->DW_Regelung.Messwert_A_mf * 0.768F;
     ...
     Soll_IBF->DW_Regelung.ri = Ist_IBF.DW_Regelung.Tastrollen_Radius + sqrt( pow(ri_block1, 2) + pow(ri_block2, 2) ) ; 

     Soll_IBF->DW_Regelung.Wanddicke_berechnet = 0.5 * Ist_IBF.da  - Soll_IBF->DW_Regelung.ri;     
 ...
 void Alpha(struct Def_IBF_Allgemein_IST Ist_IBF, struct Def_IBF_Allgemein_SOLL *Soll_IBF)
 {
    ...
    Hilf_k = Ist_IBF.DW_Regelung.Abstand_C - (Soll_IBF->DW_Regelung.Messwert_A_mf - Ist_IBF.DW_Regelung.Tastrollen_Radius) * 0.64F;
 
    Hilf_w = (Soll_IBF->DW_Regelung.Messwert_A_mf - Ist_IBF.DW_Regelung.Tastrollen_Radius) * 0.768F;
 
    Hilf_l = Ist_IBF.AG_Pos + Ist_IBF.DW_Regelung.Offset;
    Hilf_z = Hilf_l - 0.5 * Ist_IBF.da - Hilf_w;
 
    Soll_IBF->DW_Regelung.Alpha = atan(Hilf_k / Hilf_z)* 180/3.14159265358979323846;  
 ...
 void Gamma(struct Def_IBF_Allgemein_IST Ist_IBF, struct Def_IBF_Allgemein_SOLL *Soll_IBF)
 {
  ...
  Soll_IBF->DW_Regelung.Gamma = acos(Hilf_tp/Soll_IBF->DW_Regelung.ri)* 180/3.14159265358979323846;
...
void Beta(struct Def_IBF_Allgemein_IST Ist_IBF, struct Def_IBF_Allgemein_SOLL *Soll_IBF)
                  ...
                  struct Def_IBF_Allgemein_SOLL *Soll_IBF)
 {
   ...
   Soll_IBF->DW_Regelung.T_Einlauf = (Soll_IBF->DW_Regelung.Beta * Ist_IBF.da * 3.14159265358979323846)/(360.0F *  Ist_IBF.DW_Regelung.U_v_HW);
...
void DW_Regelalgo(struct Def_IBF_Allgemein_IST Ist_IBF, 
                  struct Def_IBF_Allgemein_SOLL *Soll_IBF)
 {
    ...
    Soll_IBF->DW_Regelung.Anzahl_Zeitschritte = (int)(Delta_T/(5*0.1F)); 
    ...
    Soll_IBF->DW_Regelung.DW_soll_Pos[20-1] = 0; 
    
    Soll_IBF->DW_Regelung.DW_soll_Pos[Soll_IBF->DW_Regelung.Anzahl_Zeitschritte] = Soll_IBF->DW_Regelung.Wanddicke_berechnet; 

    if(Soll_IBF->DW_Regelung.DW_soll_Pos[0] == 0) Soll_IBF->RS_Pos = Ist_IBF.RS_Pos;
    else  Soll_IBF->RS_Pos = Soll_IBF->DW_Regelung.DW_soll_Pos[0] + 2.0F;    
                       ...
                       struct Def_IBF_Allgemein_SOLL *Soll_IBF)
{
  ...
  {    
    ...
    case 1: 
         ...
         if(Soll_IBF->DW_Regelung.Aufrufzeit_Regelzykl >= (5 - 1))
         {
