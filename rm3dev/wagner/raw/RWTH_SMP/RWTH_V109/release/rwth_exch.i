#line 1 "C:\\rm3dev\\wagner\\raw\\RWTH_SMP\\RWTH_V109\\RWTH_SMP.bd\\source\\rwth_exch.cpp"
...
#line 27 "C:\\rm3dev\\wagner\\raw\\RWTH_SMP\\RWTH_V109\\RWTH_SMP.bd\\source\\rwth_exch.cpp"
...
#line 28 "C:\\rm3dev\\wagner\\raw\\RWTH_SMP\\RWTH_V109\\RWTH_SMP.bd\\source\\rwth_exch.cpp"


    
   ofstream            DebugFile ("C:\\Test_Debug\r_test.txt");
...
#line 33 "C:\\rm3dev\\wagner\\raw\\RWTH_SMP\\RWTH_V109\\RWTH_SMP.bd\\inc\\rwth_task.hpp"
...
#line 34 "C:\\rm3dev\\wagner\\raw\\RWTH_SMP\\RWTH_V109\\RWTH_SMP.bd\\inc\\rwth_task.hpp"
...
#line 35 "C:\\rm3dev\\wagner\\raw\\RWTH_SMP\\RWTH_V109\\RWTH_SMP.bd\\inc\\rwth_task.hpp"
...
#line 38 "C:\\rm3dev\\wagner\\raw\\RWTH_SMP\\RWTH_V109\\RWTH_SMP.bd\\source\\rwth_exch.cpp"
#line 1 "C:\\rm3dev\\wagner\\raw\\RWTH_SMP\\RWTH_V109\\RWTH_SMP.bd\\inc\\ibf_tool.hpp"
...
#line 39 "C:\\rm3dev\\wagner\\raw\\RWTH_SMP\\RWTH_V109\\RWTH_SMP.bd\\source\\rwth_exch.cpp"
...
RWTH_EXCH::RWTH_EXCH(void)
{
	...
	Ist_IBF.counter = 1;
	Ist_IBF.countDebug = 1;

    Soll_IBF.InitAchse    = 'a';
    Soll_IBF.stuetz_var.skip_faktor = 1; 
    Soll_IBF.stuetz_var.merker = 0; 
    Soll_IBF.stuetz_var.crtimer = 0; 
    ...
    Ist_IBF.Axial.Kr_geo.sin_kw_winkel_halbe = 0.3826834323650897717284599840304F;  
    ...
    if(!rpw->IBFPARA_auslesen(&Ist_IBF, &Soll_IBF,&Ist_Inter))
        { 
    ...
    {
    Soll_IBF.min_RS_Pos  = 10.0F; 
    Soll_IBF.min_ASO_Pos = 85.0F; 
    }
    else Soll_IBF.min_ASO_Pos = 25.0F;


    Soll_IBF.Zeit.t_Halte= 20;    
    Ist_IBF.Axial.Biss.Anzahl_zweite_Ebene = Ist_IBF.Axial.Biss.Anzahl + Ist_IBF.Axial.Biss.Anzahl;
    ...
    MyLogFile << "Dornwalze in Kraft beim Anwalzen [1=AN, 0=AUS]" << ":" << " "<< Ist_IBF.Flag.rs_kraftanfahren_aktiv << endl; 
    ...
    if (Ist_IBF.Flag.Axial_Radialwalzen == 1)
    {
    ...
    if(Ist_IBF.Flag.Axial_Radialwalzen == 0)
     ...
     if(Ist_IBF.Axial.Turbine.Turbinenscheibe == 1)
        {
        MyLogFile << "Strategie Turbinenscheibe vorgewählt" << endl;
        MyLogFile << endl;
        if(Ist_IBF.Flag.Bissverhaeltnis == 1)
            {
            MyLogFile << "Pro Ebene werden " << Ist_IBF.Axial.Biss.Anzahl << " Bisse mit dem Versatz von je  " << Ist_IBF.Axial.Biss.Verhaeltnis << "  Prozent gemacht" << endl;
            MyLogFile << " Insgesamt werden " << Ist_IBF.Axial.Biss.Anzahl_zweite_Ebene << " Bisse gewalzt" << endl;
            MyLogFile << endl;
            MyLogFile << "1. Profiltiefe (1. Ebene 1. Profil)            "  << "= " << Ist_IBF.Axial.Pr_Tiefe[0]                << endl;     
            MyLogFile << "2. Profiltiefe (1. Ebene 2. Profil)            "  << "= " << Ist_IBF.Axial.Pr_Tiefe[1]                << endl; 
            MyLogFile << "3. Profiltiefe (1. Ebene 3. Profil)            "  << "= " << Ist_IBF.Axial.Pr_Tiefe[2]                << endl;     
            MyLogFile << endl;
            MyLogFile << "4. Profiliertiefe (2. Ebene 1. Profil)            "  << "= " << Ist_IBF.Axial.Pr_Tiefe[3]                << endl;     
            MyLogFile << "5. Profiliertiefe (2. Ebene 2. Profil)            "  << "= " << Ist_IBF.Axial.Pr_Tiefe[4]                << endl; 
            MyLogFile << "6. Profiliertiefe (2. Ebene 3. Profil)            "  << "= " << Ist_IBF.Axial.Pr_Tiefe[5]                << endl; 
            MyLogFile << endl;
            MyLogFile << "1. Profilierposition 1. Ebene                      "  << "= " << Ist_IBF.Axial.AGR_Pr[0]   << " mm"      << endl;
            MyLogFile << "1. Profilierposition 2. Ebene                      "  << "= " << Ist_IBF.Axial.AGR_Pr[3]   << " mm"      << endl;
            MyLogFile << endl;
              }
        else 
            {
     ...
     MyLogFile << endl;
     if(Ist_IBF.Flag.DA_Jenkouk_DW_Regelung == 1)
     {
     MyLogFile << "***!!! DA-Dornwalzenregelung vorgewählt !!!***"    << endl;
     if (Ist_IBF.Flag.DA_Jenkouk_Messen_ohne_Fahren !=0) 
        {
        MyLogFile << "Es wird gemessen und die Dornwalze (idealerweise) verfahren" << endl;
        }
     else MyLogFile << "Es wird NUR gemessen" << endl;
     
     MyLogFile << "Nachfolgende Werte wurden eingelsen"                     << endl;
     MyLogFile << "Abstand C :" << Ist_IBF.DW_Regelung.Abstand_C           << endl;
     MyLogFile << "Nullpunkt :" << Ist_IBF.DW_Regelung.Messwert_Nullpunkt  << endl;
     MyLogFile << "TR-Radius :" << Ist_IBF.DW_Regelung.Tastrollen_Radius   << endl;
     MyLogFile << "Offset    :" << Ist_IBF.DW_Regelung.Offset              << endl;
     
     }
     else MyLogFile << "Jenkouk Regler EIN(1) oder AUS(0) ? ->:" << Ist_IBF.Flag.DA_Jenkouk_DW_Regelung << endl;
     MyLogFile << endl;
    ...
    if(Ist_IBF.Flag.Bissverhaeltnis == 1)
        {
        Soll_IBF.Axial.AGR_Pr[0] = Ist_IBF.Axial.AGR_Pr[0]; 
        Soll_IBF.Axial.Biss.AGR_Pr_Merker = Ist_IBF.Axial.AGR_Pr[0];
        }
    ...
    if(RmGetEntry(((ulong) ((15) * 1000ul)), Mailboxl, &Entry) == 4)
    {
    ...
    else
    {
        ...
        if(RmGetEntry(((ulong) ((1) * 1000ul)), Powercon_SendSema, &Entry) == 4)
        {
        ...
        {
            Sema_PowerSendID = Entry.id;    

            if(RmGetEntry(((ulong) ((1) * 1000ul)), Powercon_RecSema, &Entry) == 4)
            {
            ...
            {
                Sema_PowerRecID = Entry.id; 

                if(RmReceiveMail(((ulong) ((1) * 1000ul)), TRT_Mail_id, &TRT_Mail) == 4)
                {
...
int RWTH_EXCH::put_puff(void)
{
    ...
    {
        if(RmGetBinSemaphore(((ulong) (25)), Sema_PowerRecID) == 4)
          return(0);
        ...
        RwwtPool->Status_RWTH = 0 | Blinker;
        RwwtPool->Data_availableRWTH = (~0);
...
int RWTH_EXCH::get_puff(void)
{
    if(running_flag)
    {
        if(RwwtPool->Steuer_RWTH == 2)
            finish_flag = (~0);
    }
    if(running_flag && RwwtPool->Data_initialed && RwwtPool->Data_available)
    {
        RwwtPool->Status_RWTH = 3 | Blinker;
...
int RWTH_EXCH::Main_Control(void)
{
   ...
   DebugFile << "Datei erstellt" << endl;
   DebugFile << "Dies ist der " << iter_IBF << " Durchlauf" << endl;


   if(running_flag && RwwtPool->Data_initialed && RwwtPool->Data_available)
   {
   	  DebugFile << "Erstmaliger Aufruf" << endl; 
      if(++CountBlinker > 10)
      {
         CountBlinker = 0;
         Blinker ^= 16;
      }
      RwwtPool->Status_RWTH = 2 | Blinker;
...
#line 521 "C:\\rm3dev\\wagner\\raw\\RWTH_SMP\\RWTH_V109\\RWTH_SMP.bd\\source\\rwth_exch.cpp"
     time_t start, end;
      ...
      {
	  	DebugFile << "Wiederholtes Aufrufen von main" << endl;
        ctime(&start);
        iter_IBF++;
      ...
      aus_onli.Ibf_nominal.RS_act  = 1;                     
      aus_onli.Ibf_nominal.AS_act  = 1;                     
      aus_onli.Ibf_nominal.Zen_act = 0;                     
      aus_onli.Ibf_nominal.AG_act  = Soll_Inter.ag_act;     
                                     
       
      aus_onli.Ibf_nominal.RS_mode  = Soll_Inter.rs_mode;                   
      aus_onli.Ibf_nominal.AS_mode  = Soll_Inter.aso_mode;                  
      aus_onli.Ibf_nominal.AG_mode = Soll_Inter.ag_mode;                   
      aus_onli.Ibf_nominal.Zen_mode = Soll_Inter.zar_kraftregler_aktiv;     

       
      aus_onli.ds_dh_sp_hp.s_punkt = Soll_Inter.rs_v  * ein_onli.rwg_poti_wert;  
      aus_onli.ds_dh_sp_hp.h_punkt = Soll_Inter.aso_v * ein_onli.rwg_poti_wert;  
      aus_onli.Ibf_nominal.Soll_AG_V = Soll_Inter.ag_v;                          
      aus_onli.Ibf_nominal.Soll_ZA_V = Soll_Inter.zal_v;                         
      aus_onli.Ibf_nominal.Soll_ZE_V = Soll_Inter.zar_v;                         
      
       
      aus_onli.Ibf_nominal.Soll_RS_Pos = Soll_Inter.rs_pos;           
      aus_onli.Ibf_nominal.Soll_AS_Pos = Soll_Inter.aso_pos;          
      aus_onli.Ibf_nominal.Soll_AG_Pos = Soll_Inter.ag_pos;           
      
       
      aus_onli.Ibf_nominal.Soll_ZA_Pos = Soll_Inter.zar_pos ;           
      aus_onli.Ibf_nominal.Soll_ZE_Pos = Soll_Inter.zal_pos ;           
      		 	
       
      
      aus_puff.n_omega.n_aw_motor_g_o = Soll_Inter.kwo_n; 
      aus_puff.n_omega.n_aw_motor_g_u = Soll_Inter.kwu_n; 
      
       
      

       
      aus_onli.Ibf_nominal.Soll_FR  = Soll_Inter.rs_kraft;            
      aus_onli.Ibf_nominal.Soll_FA  = Soll_Inter.aso_kraft;              
      aus_onli.Ibf_nominal.Soll_FAG = Soll_Inter.ag_kraft;            
      aus_onli.Ibf_nominal.Soll_FZ  = Soll_Inter.zal_kraft;           
