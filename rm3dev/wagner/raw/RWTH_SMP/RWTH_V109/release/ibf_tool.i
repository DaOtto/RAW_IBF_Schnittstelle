#line 1 "C:\\rm3dev\\wagner\\raw\\RWTH_SMP\\RWTH_V109\\RWTH_SMP.bd\\source\\ibf_tool.cpp"
...
#line 2 "C:\\rm3dev\\wagner\\raw\\RWTH_SMP\\RWTH_V109\\RWTH_SMP.bd\\source\\ibf_tool.cpp"
    ...
    void Axialkraft(struct Def_IBF_Allgemein_IST Ist_IBF, struct Def_IBF_Allgemein_SOLL *Soll_IBF)
    {
      ...
      if(Ist_IBF.Flag.Axial_Radialwalzen == 0)
        {
            Soll_IBF->AS_Kraft  = Ist_IBF.Flag.as_kraftregler_aktiv  ? Soll_IBF->AS_Kraft_Vorgabe  : 400000.0F ;  
        }
      else
        {
            Soll_IBF->AS_Kraft  = Ist_IBF.Flag.as_kraftregler_aktiv  ? Soll_IBF->AS_Kraft_Vorgabe  : 400000.0F ; 
    ...
    void Kraftsteuerung(struct Def_IBF_Allgemein_IST Ist_IBF, struct Def_IBF_Allgemein_SOLL *Soll_IBF)
    {
        ...
        Soll_IBF->RS_Kraft  = Ist_IBF.Flag.rs_kraftregler_aktiv  ? Soll_IBF->RS_Kraft_Vorgabe  : 60000.0F ;   
    ...
    void Anwalzen_Radial(struct Def_IBF_Allgemein_IST Ist_IBF, struct Def_IBF_Allgemein_SOLL *Soll_IBF) 
     {
        ...
        Soll_IBF->AG_Kraft  = Ist_IBF.Flag.ag_kraftregler_aktiv  ? Soll_IBF->AG_Kraft_Vorgabe  :  100001.0F ; 
        Soll_IBF->ZAR_Kraft = Ist_IBF.Flag.zal_kraftregler_aktiv ? Soll_IBF->ZAL_Kraft_Vorgabe :  10001.0F ;  
        Soll_IBF->ZAL_Kraft = Ist_IBF.Flag.zar_kraftregler_aktiv ? Soll_IBF->ZAR_Kraft_Vorgabe :  10001.0F ;  
 
        
        if (Ist_IBF.Flag.rs_kraftanfahren_aktiv == 1) 
         {
           Soll_IBF->RS_Kraft = Ist_IBF.Flag.rs_kraftanfahren_aktiv ? Soll_IBF->RS_Kraft_Anfahren : 80001.0F ; 
         }
        else
           Soll_IBF->RS_Kraft = Ist_IBF.Flag.rs_kraftregler_aktiv ? Soll_IBF->RS_Kraft_Vorgabe: 80002.0F;      
    ...
    void Anwalzen_Axial(struct Def_IBF_Allgemein_IST Ist_IBF, struct Def_IBF_Allgemein_SOLL *Soll_IBF) 
     {
        ...
        Soll_IBF->RS_Kraft  = Ist_IBF.Flag.rs_kraftregler_aktiv  ? Soll_IBF->RS_Kraft_Vorgabe  :  100002.0F;   
        Soll_IBF->AG_Kraft  = Ist_IBF.Flag.ag_kraftregler_aktiv  ? Soll_IBF->AG_Kraft_Vorgabe  :  10002.0F ;   
        Soll_IBF->ZAR_Kraft = Ist_IBF.Flag.zal_kraftregler_aktiv ? Soll_IBF->ZAL_Kraft_Vorgabe :  10002.0F ;   
        Soll_IBF->ZAL_Kraft = Ist_IBF.Flag.zar_kraftregler_aktiv ? Soll_IBF->ZAR_Kraft_Vorgabe :  10002.0F ;   
     ...
     void IBF_Abschaltung(struct Def_Soll_Inter *Soll_Inter,struct Def_IBF_Allgemein_IST Ist_IBF)
     {
         ...
         if(Ist_IBF.Flag.ag_kraftregler_aktiv) 
             {
     ...
     int RPW::Modus_AG(struct Def_Soll_Inter *Soll_Inter, struct Def_IBF_Allgemein_IST *Ist_IBF, int Auswahl)
     {
        ...
        case 0: 
                Soll_Inter->ag_mode = 0x05; 
                break;
        case 1: 
                Soll_Inter->ag_mode = 0x01; 
                break;
        }
    ...
    void Breitungsexp(struct Def_IBF_Allgemein_IST Ist_IBF, struct Def_IBF_Allgemein_SOLL *Soll_IBF)
    {
        ...
        Soll_IBF->Radial.Breitung.qf = Ist_IBF.Radial.s_f / Ist_IBF.Radial.Werkzeugbreite ;  
        Soll_IBF->Radial.Breitung.ga = Ist_IBF.Radial.s_f / Soll_IBF->Radial.Rohlinghoehe;   
        ...
        Soll_IBF->Radial.Breitung.e_mr = pow(2.7182818284, -1*(Ist_IBF.Radial.Breitung.mr));
    }
    ...
    void Volumenbestimmung(struct Def_IBF_Allgemein_IST Ist_IBF, struct Def_IBF_Allgemein_SOLL *Soll_IBF)
    {
        ...
        Soll_IBF->Radial.Breitung.Volumen_t1 = 3.14159265358979323846/4 * Ist_IBF.Radial.Werkzeugbreite *(  Soll_IBF->Radial.Breitung.Da_t2_h2 
    ...
    void Hoehenzunahme(struct Def_Ist_Inter Ist_Inter, struct Def_IBF_Allgemein_IST Ist_IBF, struct Def_IBF_Allgemein_SOLL *Soll_IBF)
    {
        ...
        Soll_IBF->Radial.Breitung.delta_h = 12 * Soll_IBF->Radial.Breitung.Volumen_diff / ( 3.14159265358979323846 * (
    ...
    int AGR_Pr_Wanddicken_Verhaeltnis_proz(struct Def_Ist_Inter Ist_Inter, struct Def_IBF_Allgemein_IST Ist_IBF, struct Def_IBF_Allgemein_SOLL *Soll_IBF)
    {
        ...
        Soll_IBF->Axial.Verh_pr_sf_proz_start = (Ist_IBF.Axial.AGR_Pr[Ist_IBF.Axial.Pr_Num]/Ist_IBF.Vorring.Wandstaerke_Null) * 100.0F; 
        Soll_IBF->Axial.Verh_pr_sf_proz       = (Ist_IBF.Axial.AGR_Pr[Ist_IBF.Axial.Pr_Num]/Ist_Inter.s0a) * 100.0F;                    
        return -1;
    }
    ...
    char AGR_Nachfuehr_Entscheider(struct Def_Ist_Inter Ist_Inter, struct Def_IBF_Allgemein_IST Ist_IBF, struct Def_IBF_Allgemein_SOLL *Soll_IBF)
    {
        ...
        if(Soll_IBF->Axial.Verh_pr_sf_proz <= 60.0F) 
            {
                Soll_IBF->Axial.Wert = 'A';
                Wert = 'A';
            }
        else if(Soll_IBF->Axial.Verh_pr_sf_proz > 60.0F) 
            {
    ...
    int RPW::IBFPARA_auslesen(struct Def_IBF_Allgemein_IST *Ist_IBF,
                              struct Def_IBF_Allgemein_SOLL *Soll_IBF,
							                struct Def_Ist_Inter *Ist_Inter)
    {
         ...
         if(!iniFile.ReadFile()) 
         ...
         else 
           {
            ...
            Ist_IBF->Flag.Axial_Radialwalzen  = iniFile.GetValueI( "IBF_Wahlschalter Axialprofilieren(0) Radialprofilieren(1) Formenspektrum(2) Schuessel(3)", "Axial / Radial/ Formensp/ Schuessel", 0);
			...
			iniFile.NumValues("IBF-Variablen Schuesselwalzen");
      		Soll_IBF->IBF_Schuessel.abbruchRinghoehenDifferenz =  500;
			Soll_IBF->IBF_Schuessel.endWandhoehe_Schuessel=
				iniFile.GetValueI( "IBF-Variablen Schuesselwalzen", "Endwandhoehe_Schuessel");
			
			
			iniFile.NumValues("IBF_Werkzeug Zentrierarm-Rollen"); 
			Ist_Inter->Werkzeug.werkzeug_zr.dist_Hauptwalze_SenkrechteZentrierarmfixpunkt=
				iniFile.GetValueF("IBF_Werkzeug Zentrierarm-Rollen",
                          "Distanz_Hauptwalze_SenkrechteZentrierarmfixpunkt_Rechts",
                          350);
			Ist_Inter->Werkzeug.werkzeug_zl.dist_Hauptwalze_SenkrechteZentrierarmfixpunkt=
				iniFile.GetValueF("IBF_Werkzeug Zentrierarm-Rollen",
                          "Distanz_Hauptwalze_SenkrechteZentrierarmfixpunkt_Links",
                          350);  
			Ist_Inter->Werkzeug.werkzeug_zr.durchmesser_zr=
				iniFile.GetValueF("IBF_Werkzeug Zentrierarm-Rollen", 
                          "Durchmesser_Zentrierrolle_Rechts",
                          100);
			Ist_Inter->Werkzeug.werkzeug_zl.durchmesser_zr= 
				iniFile.GetValueF("IBF_Werkzeug Zentrierarm-Rollen", 
                          "Durchmesser_Zentrierrolle_Links", 
                          100);
			Ist_Inter->Werkzeug.werkzeug_zr.dist_Mittelachse_Zentrierarmfixpunkt=
				iniFile.GetValueF("IBF_Werkzeug Zentrierarm-Rollen", 
                          "Distanz_FixpunktZentrierarm_MittelachseWalzwerk_Rechts", 
                          1000);
			Ist_Inter->Werkzeug.werkzeug_zl.dist_Mittelachse_Zentrierarmfixpunkt=
				iniFile.GetValueF("IBF_Werkzeug Zentrierarm-Rollen",
                          "Distanz_FixpunktZentrierarm_MittelachseWalzwerk_Links", 
                          1000);
			Ist_Inter->Werkzeug.werkzeug_zr.dist_Kolbenende_Zentrierarmfixpunkt=
				iniFile.GetValueF("IBF_Werkzeug Zentrierarm-Rollen",
                          "Distanz_Kolbenende_FixpunktZentrierarm_Rechts", 
                          700);
			Ist_Inter->Werkzeug.werkzeug_zl.dist_Kolbenende_Zentrierarmfixpunkt=
				iniFile.GetValueF("IBF_Werkzeug Zentrierarm-Rollen",
                          "Distanz_Kolbenende_FixpunktZentrierarm_Links", 
                          700);
			Ist_Inter->Werkzeug.werkzeug_zr.dist_Fixpunkt_Zentrierrolle=
				iniFile.GetValueF("IBF_Werkzeug Zentrierarm-Rollen",
                          "Distanz_FixpunktZentrierarm_Zentrierrolle_Rechts", 
                          1500);	
			Ist_Inter->Werkzeug.werkzeug_zl.dist_Fixpunkt_Zentrierrolle=
				iniFile.GetValueF("IBF_Werkzeug Zentrierarm-Rollen", 
                          "Distanz_FixpunktZentrierarm_Zentrierrolle_Links", 
                          1500);
			Ist_Inter->Werkzeug.werkzeug_zr.dist_Kolben_Zentrierarm=
				iniFile.GetValueF("IBF_Werkzeug Zentrierarm-Rollen", 
                          "Distanz_Kolbenfixpunkt_FixpunktZentrierarm_Rechts", 
                          1800);
			Ist_Inter->Werkzeug.werkzeug_zl.dist_Kolben_Zentrierarm=
				iniFile.GetValueF("IBF_Werkzeug Zentrierarm-Rollen", 
                          "Distanz_Kolbenfixpunkt_FixpunktZentrierarm_Links", 
                          1800);
			Ist_Inter->Werkzeug.werkzeug_zr.dist_Kolbenende_Zentrierrolle=
				iniFile.GetValueF("IBF_Werkzeug Zentrierarm-Rollen", 
                          "Distanz_Kolbenende_Zentrierrolle_Rechts", 
                          1800);
			Ist_Inter->Werkzeug.werkzeug_zl.dist_Kolbenende_Zentrierrolle=
				iniFile.GetValueF("IBF_Werkzeug Zentrierarm-Rollen",
                          "Distanz_Kolbenende_Zentrierrolle_Links", 
                          1800);
			Ist_Inter->Werkzeug.werkzeug_zr.dist_Mittelachse_Kolbenfixpunkt=
				iniFile.GetValueF("IBF_Werkzeug Zentrierarm-Rollen",
                          "Distanz_Kolbenfixpunkt_MittelachseWalzwerk_Rechts", 
                          500);
			Ist_Inter->Werkzeug.werkzeug_zl.dist_Mittelachse_Kolbenfixpunkt=
				iniFile.GetValueF("IBF_Werkzeug Zentrierarm-Rollen", 
                          "Distanz_Kolbenfixpunkt_MittelachseWalzwerk_Links", 
                          500);
      ...
      Ist_IBF->Test.Flag  = 
        iniFile.GetValueI("IBF-Testwalzung - Walzparameter", 
                          "Testfahrt (0->Nein 1->Ja)", 
                          0);
      Ist_IBF->Test.Ring_AD  = 
        iniFile.GetValueF( "IBF-Testwalzung - Walzparameter", 
                            "Test_Ringdurchmesser", 
                            1500);
