#line 1 "C:\\rm3dev\\wagner\\raw\\RWTH_SMP\\RWTH_V109\\RWTH_SMP.bd\\source\\ibf_stuetz.cpp"
...
#line 2 "C:\\rm3dev\\wagner\\raw\\RWTH_SMP\\RWTH_V109\\RWTH_SMP.bd\\source\\ibf_stuetz.cpp"
...
void stuetzstellen(struct Def_Ist_Inter Ist_Inter, struct Def_IBF_Allgemein_IST Ist_IBF, struct Def_IBF_Allgemein_SOLL *Soll_IBF)
{
					...
					if (Soll_IBF->stuetz_var.crtimer <= 100)   
			      	{					      	
					      if ((Soll_IBF->stuetz_var.stellen[0][25-1] > 0) && (Soll_IBF->stuetz_var.stellen[0][0] > 0))	
							{
								
								
							}
               
                     		Soll_IBF->stuetz_var.crtimer = (float)(1000*Ist_Inter.Werkzeug.Ringumdrehung / 25);   
                     		
                            if (Soll_IBF->stuetz_var.crtimer <= 100)
							{
								
                        Soll_IBF->stuetz_var.skip_faktor = (int)(25 / (10 * Ist_Inter.Werkzeug.Ringumdrehung) ); 
							...
							for(int i_for = 0; i_for < Soll_IBF->stuetz_var.skip_faktor; i_for++)
							{
								...
								{	
									if ((Soll_IBF->stuetz_var.merker-i_for-1)<=0)	
									{
										Soll_IBF->stuetz_var.stellen[0][Soll_IBF->stuetz_var.merker] = (float)(( Soll_IBF->stuetz_var.stellen[0][(Soll_IBF->stuetz_var.merker-i_for-1+25)] + Ist_IBF.RS_Pos )/2);
										if (Soll_IBF->stuetz_var.stellen[0][(Soll_IBF->stuetz_var.merker-i_for-1+25)] == 0) Soll_IBF->stuetz_var.stellen[0][Soll_IBF->stuetz_var.merker] = Ist_IBF.RS_Pos;
										Soll_IBF->stuetz_var.stellen[1][Soll_IBF->stuetz_var.merker] = (float)(( Soll_IBF->stuetz_var.stellen[1][(Soll_IBF->stuetz_var.merker-i_for-1+25)] + Ist_IBF.ASO_Pos )/2);
										if (Soll_IBF->stuetz_var.stellen[1][(Soll_IBF->stuetz_var.merker-i_for-1+25)] == 0) Soll_IBF->stuetz_var.stellen[1][Soll_IBF->stuetz_var.merker] = Ist_IBF.ASO_Pos;
									}
									else
									{
								...
								if (Soll_IBF->stuetz_var.merker >= 25) Soll_IBF->stuetz_var.merker = 0; 
							}
							
					}
					else Soll_IBF->stuetz_var.crtimer = Soll_IBF->stuetz_var.crtimer - 100; 
				


                    Soll_IBF->stuetz_var.kontrollmerker = Soll_IBF->stuetz_var.kontrollmerker + (float)(25 / (10 * Ist_Inter.Werkzeug.Ringumdrehung) );

                    if (int(Soll_IBF->stuetz_var.kontrollmerker) > Soll_IBF->stuetz_var.merker)
                        {
                        	if (int(Soll_IBF->stuetz_var.kontrollmerker) >= 25)
                    	       {
                        		Soll_IBF->stuetz_var.kontrollmerker = Soll_IBF->stuetz_var.kontrollmerker - 25;
                        		if (int(Soll_IBF->stuetz_var.kontrollmerker) < Soll_IBF->stuetz_var.merker)
                            		{
                        			for(int i_for = Soll_IBF->stuetz_var.merker; i_for < 25; i_for++)
			                            {
...
#line 144 "C:\\rm3dev\\wagner\\raw\\RWTH_SMP\\RWTH_V109\\RWTH_SMP.bd\\source\\ibf_stuetz.cpp"
...
void konst_cr_radial(struct Def_Ist_Inter Ist_Inter, struct Def_IBF_Allgemein_IST Ist_IBF, struct Def_IBF_Allgemein_SOLL *Soll_IBF)
{
    ...
    if ((Soll_IBF->stuetz_var.stellen[0][25-1] > 0) && (Soll_IBF->stuetz_var.crtimer <= 100))	
      {
        
		float S0r, S1r, Smr, dHstrich, d_innen, dDstrich, rrstrich;	

		S0r = Soll_IBF->stuetz_var.stellen[0][Soll_IBF->stuetz_var.merker]; 
		S1r = (float)(Ist_IBF.RS_Pos); 
		...
		d_innen = (float)(Ist_Inter.da - 2*Smr); 
		...
		if (Ist_IBF.stuetz_var.cr <= 0.001)	
			{
...
void konst_cr_axial(struct Def_Ist_Inter Ist_Inter, struct Def_IBF_Allgemein_IST Ist_IBF, struct Def_IBF_Allgemein_SOLL *Soll_IBF)
{
					...
					if ((Soll_IBF->stuetz_var.stellen[1][25-1] > 0) && (Soll_IBF->stuetz_var.crtimer <= 100))	
					{
					
                    float h0a, h1a, hma, axi_Rm, axi_e;	
					
                   	h0a = Soll_IBF->stuetz_var.stellen[1][Soll_IBF->stuetz_var.merker]; 
					h1a = (float)Ist_IBF.ASO_Pos;  
					hma = (h0a + h1a) / 2;  
        			...
        			axi_e = axi_Rm - Ist_IBF.Axial.Kr_geo.Del_Kr_AGR - Ist_IBF.Axial.Kr_geo.Kr_Br/2;		

                    
               		if (Ist_IBF.stuetz_var.ca <= 0.001)	
	       				{
		  				Soll_IBF->stuetz_var.ca = (sqrt((h0a-h1a)*tan(22.5*3.14159265358979323846/180)*(axi_Rm-axi_e)))/hma;
                        Soll_IBF->stuetz_var.delta_h = (float)(pow(Soll_IBF->stuetz_var.ca,2)*pow(hma,2)/(tan(22.5*3.14159265358979323846/180)*(axi_Rm-axi_e)));
		      			}
						
			 		else Soll_IBF->stuetz_var.delta_h = (float)(pow(Ist_IBF.stuetz_var.ca,2)*pow(hma,2)/(tan(22.5*3.14159265358979323846/180)*(axi_Rm-axi_e)));
                    }
