#line 1 "C:\\rm3dev\\wagner\\raw\\RWTH_SMP\\RWTH_V109\\RWTH_SMP.bd\\source\\rpw.cpp"
...
#line 2 "C:\\rm3dev\\wagner\\raw\\RWTH_SMP\\RWTH_V109\\RWTH_SMP.bd\\source\\rpw.cpp"




    
	ofstream DebugFile ("C:\\Test_Debug\rpw_main.txt");
                  ...
                  struct Def_IBF_Allgemein_IST   *Ist_IBF   )
{
   ...
   if(Ist_IBF->debug_InnerSwitchCase == 4){
     Ist_IBF->debug_InnerSwitchCase = 5;
   }
   ...
   if(Ist_IBF->debug_InnerSwitchCase == 5){
     Ist_IBF->debug_InnerSwitchCase = 6;
   }
                        ...
                        )
{
    ...
    Ist_Inter->ag_pos_real = Ein_Onli.Ibf_actual.Ist_AG;                 
    ...
    Ist_Inter->zar_pos   = Ein_Onli.Ibf_actual.Ist_ZEN_A;                 
    Ist_Inter->zal_pos   = Ein_Onli.Ibf_actual.Ist_ZEN_E;                 
    ...
    Ist_Inter->hw_ir     =   Ein_Puff.hw1_motor.getriebe_untersetzung;               
    Ist_Inter->kw_ia     =   Ein_Puff.awu_motor.getriebe_untersetzung;               
    sin_kw_winkel_halbe  =   (float) sin(Ein_Puff.awu_geometrie.winkel_bo * 0.5F);   
    ...
    Ist_Inter->fertig_ho_soll  = Aus_Puff.ist_walzform.hm;
  	...
  	Ist_Inter->h0r             = Aus_Puff.h0r;     					 
  	Ist_Inter->h1r             = Aus_Puff.h1r;     					 
  	Ist_Inter->h0a             = Aus_Puff.h0a;     					   		
    Ist_Inter->h1a             = Aus_Puff.h1a;     					 
  	Ist_Inter->h1a_of          = Ein_Puff.form_mess_of.dis_aw;
  	
    Ist_Inter->s0a             = Aus_Puff.s0a;     					 
  	Ist_Inter->s0r             = Aus_Puff.s0r;     					 
  	Ist_Inter->s1a             = Aus_Puff.s1a;     					 
  	Ist_Inter->s1r             = Aus_Puff.s1r;     					 
  	Ist_Inter->s1r_of          = Ein_Puff.form_mess_of.dis_hw_dw;
	Ist_Inter->sfh             = Aus_Puff.s_ekv;					 
  	
    Ist_Inter->skw             = 0.0F;                    
  	Ist_Inter->skw_of          = 0.0F;                      		
  	Ist_Inter->wa_dvol         = Aus_Puff.dvol_ring_proz;       
    
    Ist_Inter->Vorform.sm      = Ein_Puff.vorform.sm;           
    Ist_Inter->Vorform.da      = Ein_Puff.vorform.da;           
    Ist_Inter->Vorform.hm      = Ein_Puff.vorform.hm;           


    if(Ist_Inter->Test.Flag == 0)  
    {
       Ist_Inter->hw_n      =   Ein_Puff.n_hw_motor_ist  / Ist_Inter->hw_ir ;       
       Ist_Inter->kwo_n     =   Ein_Puff.n_awo_motor_ist / Ist_Inter->kw_ia ;               
       Ist_Inter->kwu_n     =   Ein_Puff.n_awu_motor_ist / Ist_Inter->kw_ia ;       
    }
    else if(Ist_Inter->Test.Flag == 1)
        {
        Ist_Inter->hw_n      =   20.0F ;       
        Ist_Inter->kwo_n     =   16.0F ;               
        Ist_Inter->kwu_n     =   16.0F ;       
        }

    Ist_Inter->Werkzeug.Drehzahl_HW             = Ist_Inter->hw_n;                                       
    Ist_Inter->Werkzeug.Winkelgeschw_omega_HW   = Ist_Inter->hw_n * (2 * 3.14159265358979323846);                            
    Ist_Inter->Werkzeug.Winkel_grad_tU_HW       = Ist_Inter->Werkzeug.Winkelgeschw_omega_HW * 180/3.14159265358979323846;    
    Ist_Inter->Werkzeug.tU_HW                   = 1 / Ist_Inter->hw_n;                                   
    Ist_Inter->Werkzeug.U_v_HW                  = Ist_Inter->Werkzeug.Winkelgeschw_omega_HW
                                                  * Ist_Inter->Werkzeug.Durchmesser_HW / 2;               

    if(Ist_Inter->hw_n == 0) 
                    {Ist_Inter->Werkzeug.Ringumdrehung = 0.0F;}
    
    else Ist_Inter->Werkzeug.Ringumdrehung  = Ist_Inter->da /
                                            ( (Ist_Inter->Werkzeug.Durchmesser_HW * Ist_Inter->hw_n) );      
    

    if(Ist_Inter->Werkzeug.Ringumdrehung > 500.0F)  
        Ist_Inter->Werkzeug.Ringumdrehung=0.0F;

    Ist_Inter->Werkzeug.omega_Ring          = Ist_Inter->Werkzeug.U_v_HW * 2 / Ist_Inter->da ;   
    Ist_Inter->Werkzeug.Winkel_grad_tU_Ring = Ist_Inter->Werkzeug.omega_Ring * 180/3.14159265358979323846;           
        
    Ist_Inter->Werkzeug.Antrieb_ASO.ma_ist   = 0.0F;   


     
    Ist_Inter->n_hw_motor_ist      =   Ein_Puff.n_hw_motor_ist;   
    Ist_Inter->n_kwo_motor_ist     =   Ein_Puff.n_awo_motor_ist;  
    Ist_Inter->n_kwu_motor_ist     =   Ein_Puff.n_awu_motor_ist;  
      

     
    Ist_Inter->rs_f            = Aus_Puff.fr_mf;                
    Ist_Inter->as_f            = Aus_Puff.fa_mf;                
    Ist_Inter->ag_f            = Lokal_Puff.fag_mf;                
    Ist_Inter->zar_f  = Ein_Onli.rz_f_ist_zen_einl;             
    Ist_Inter->zal_f  = Ein_Onli.rz_f_ist_zen_ausl;             
   
     
        
    Ist_Inter->Ibf_Achse1 = Ein_Onli.Ibf_actual.Ibf_Achse1;      
    Ist_Inter->Ibf_Achse2 = Ein_Onli.Ibf_actual.Ibf_Achse2;      
    Ist_Inter->Ibf_Achse3 = Ein_Onli.Ibf_actual.Ibf_Achse3;      
    Ist_Inter->Ibf_Achse4 = Ein_Onli.Ibf_actual.Ibf_Achse4;      
...

{
    ...
    Ist_IBF->Vorring.D_Null                     = Ist_Inter.Vorform.da;    
    Ist_IBF->Vorring.Start_Ringhoehe            = Ist_Inter.Vorform.hm;      
    Ist_IBF->Vorring.Wandstaerke_Null           = Ist_Inter.Vorform.sm;     
    Ist_IBF->Axial.Kr_geo.sin_kw_winkel_halbe   = sin_kw_winkel_halbe;    
    Ist_IBF->Axial.Kr_geo.l_fehlende_spitze_ukw = Ist_Inter.Werkzeug.l_fehlende_spitze;  
    ...
    Ist_IBF->da       = Ist_Inter.da;                           
    Ist_IBF->di       = Ist_Inter.di;                           
    Ist_IBF->RS_Pos   = Ist_Inter.rs_pos;                       
    Ist_IBF->AG_Pos   = Ist_Inter.ag_pos_real;                  
    
    Ist_IBF->ASO_Pos  = Ist_Inter.aso_pos;                      

    Ist_IBF->FR       = Ist_Inter.rs_f;                         
    Ist_IBF->FA       = Ist_Inter.as_f;                         
   
    Ist_IBF->Wanddicke_Ist = Ist_Inter.s1r;                     


    Ist_IBF->Zeit.Ringumdrehung = Ist_Inter.Werkzeug.Ringumdrehung; 
    ...
    Ist_IBF->Radial.s_f               = Ist_IBF->Radial.s_f_Filter.yF_neu;  
    ...
    Ist_IBF->DW_Regelung.Messwert_A     = Ist_Inter.Ibf_Achse1 - Ist_IBF->DW_Regelung.Messwert_Nullpunkt;     
    Ist_IBF->DW_Regelung.Messwert_A_unten = x_abs(Ist_Inter.Ibf_Achse2 - Ist_IBF->DW_Regelung.Messwert_Nullpunkt_unten); 
    Ist_IBF->DW_Regelung.U_v_HW         = Ist_Inter.Werkzeug.U_v_HW;                                         
    Ist_IBF->DW_Regelung.DW_Durchmesser = Ist_Inter.Werkzeug.Durchmesser_DW;                                 
                        ...
                        struct Def_IBF_Allgemein_IST  *Ist_IBF )
{
   ...
   if(Ist_IBF->debug_InnerSwitchCase == 6){
     Ist_IBF->debug_InnerSwitchCase = 7;
   }   
   ...
   Ist_IBF->RS_Pos_Start    = Soll_IBF.RS_Pos_Start; 	
   Ist_IBF->AG_Pos_Start    = Soll_IBF.AG_Pos_Start; 	
   Ist_IBF->ASO_Pos_Start   = Soll_IBF.ASO_Pos_Start; 

   Ist_IBF->Rohling_s_angefahren = Soll_IBF.Rohling_s_angefahren; 
   Ist_IBF->Rohling_h_angefahren = Soll_IBF.Rohling_h_angefahren; 

    
   Ist_IBF->Zeit.t_Halte     = Soll_IBF.Zeit.t_Halte;    
   Ist_IBF->Axial.Pr_Num     = Soll_IBF.Axial.Pr_Num;    
   ...
   Ist_IBF->Axial.Turbine.zweite_Ebene_erreicht = Soll_IBF.Axial.Turbine.zweite_Ebene_erreicht; 
               ...
               struct Def_IBF_Allgemein_SOLL *Soll_IBF)
{
   ...
   float eps = 1.0F;          
	...
	Ist_IBF.countDebug = Ist_IBF.countDebug + 1;
	  ...
	  DebugFile << "Datei wurde erstellt" << endl;
      ...
      case -1:    
                  ...
                  if((Ist_IBF.Flag.Axial_Radialwalzen == 1)||(Ist_IBF.Flag.Axial_Radialwalzen == 2)
				       || (Ist_IBF.Flag.Axial_Radialwalzen == 3)) 
                  {
                  ...
                  else if(Ist_IBF.Flag.Axial_Radialwalzen == 0) 
                  {
                    
                    Soll_IBF->AG_Pos_Start = Ist_IBF.Axial.Anfahrdurchm - Ist_IBF.Axial.Kr_geo.Del_Kr_AGR - Ist_IBF.Axial.Kr_geo.Kr_Br + Ist_IBF.Axial.Kr_geo.l_fehlende_spitze_ukw; 
   ...
   case 0:     
               ...
               switch (Ist_IBF.InitAchse) 
                 ...
                 case 'x':
                  ...
                  case 'd':    
				  			  DebugFile << "Fall d erreich" << endl;
 							  Ist_IBF.debug_InnerSwitchCase = 1;
                              ...
                              Anwalzen_Axial(Ist_IBF, Soll_IBF);   
                                    ...
                                    if(Ist_IBF.Zeit.t_Halte <= 0)
                                       {
									      ...
									      Ist_IBF.counter++;
										  Ist_IBF.debug_InnerSwitchCase = 2;
										  break;

                                        }
										if(Ist_IBF.debug_InnerSwitchCase == 2 && Soll_IBF->Zeit.t_Halte == 15.0F) {
											Ist_IBF.debug_InnerSwitchCase = 3;
										}
                                    	break;
                                  }
                                } 
                              ...
                              if(Ist_IBF.debug_InnerSwitchCase==3) {
                  			  	Ist_IBF.debug_InnerSwitchCase = 4;
							  }	
                              break;
         ...
         case 1:     
                     ...
                     else if(Ist_IBF.Flag.Axial_Radialwalzen == 1) 
                        {
					 ...
					 else if(Ist_IBF.Flag.Axial_Radialwalzen == 2) 
                        {
					 ...
					 else if(Ist_IBF.Flag.Axial_Radialwalzen == 3) 
					    {
					 	while(1 == 1) {}
        ...
        case 2:   
                   ...
                   Soll_IBF->RS_V         = Soll_IBF->Radial.Vorschubgeschw_Dw;    
                   Soll_IBF->ASO_V        = 5.0F; 
                  ...
                  Soll_IBF->Zeit.t_Halte--;
                  Soll_IBF->Radial.t_warte_flag=0; 
       ...
       case 345:  
                  ...
                  {                         
                        ...
                        case 'a': 	
                              Soll_IBF->RS_Pos=Ist_IBF.RS_Pos_Start+10.0F; 
                              Soll_IBF->RS_V = 5.0F;
                        ...
                        case 'b':
                              ...
                              Soll_IBF->ASO_Pos= Ist_IBF.ASO_Pos_Null + 15; 
                  ...
                  Soll_Inter->rs_kraftregler_aktiv      = Ist_IBF.Flag.rs_kraftregler_aktiv;    
                  ...
                  Soll_Inter->zal_pos = Soll_IBF->ZAL_Pos + 1550.0F;  
...
#line 1618 "C:\\rm3dev\\wagner\\raw\\RWTH_SMP\\RWTH_V109\\RWTH_SMP.bd\\source\\rpw.cpp"
