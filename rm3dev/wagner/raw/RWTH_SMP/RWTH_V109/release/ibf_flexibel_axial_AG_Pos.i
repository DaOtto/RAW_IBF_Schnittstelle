#line 1 "C:\\rm3dev\\wagner\\raw\\RWTH_SMP\\RWTH_V109\\RWTH_SMP.bd\\source\\ibf_flexibel_axial_AG_Pos.cpp"
...
#line 2 "C:\\rm3dev\\wagner\\raw\\RWTH_SMP\\RWTH_V109\\RWTH_SMP.bd\\source\\ibf_flexibel_axial_AG_Pos.cpp"
...
void AG_Regelalgo(struct Def_IBF_Allgemein_IST Ist_IBF, 
                  struct Def_IBF_Allgemein_SOLL *Soll_IBF)
 {
    ...
    schritt = (int)(Ist_IBF.Zeit.Ringumdrehung/(2*5*0.1F)); 
    ...
    {
     Soll_IBF->AG_Regelung.Wanddicke_axial_soll[i] = Soll_IBF->AG_Regelung.Wanddicke_axial_soll[i+1];
    }


    Soll_IBF->AG_Regelung.Wanddicke_axial_soll[20-1] = 0; 
    
    Soll_IBF->AG_Regelung.Wanddicke_axial_soll[schritt] = Ist_IBF.RS_Pos; 

    if(Soll_IBF->AG_Regelung.Wanddicke_axial_soll[0] != 0) 
        { 
          Soll_IBF->AG_Pos = Ist_IBF.AG_Pos 
                            + Ist_IBF.TR_Pos
                            - 0.08F * Soll_IBF->AG_Regelung.Wanddicke_axial_soll[0]
    ...
    Soll_IBF->AG_Regelung.wanddicke_hilf = Soll_IBF->AG_Regelung.Wanddicke_axial_soll[0];
...
void DA_Jenkouk_Regler_AG(struct Def_IBF_Allgemein_IST Ist_IBF, 
                       struct Def_IBF_Allgemein_SOLL *Soll_IBF)
{
    
    if(Soll_IBF->AG_Regelung.Aufrufzeit_Regelzykl >= (5 - 1))
    {
