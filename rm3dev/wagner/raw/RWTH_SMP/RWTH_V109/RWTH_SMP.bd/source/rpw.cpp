   ...
   // Startposition für jeweilige Ringgeometrie in axpro.h eintragen?
      ...
      case -1:    // --------------------------------------------------
                  ...
                  if((Ist_IBF.Flag.Axial_Radialwalzen == 1)||(Ist_IBF.Flag.Axial_Radialwalzen == 2)
				       || (Ist_IBF.Flag.Axial_Radialwalzen == 3)) //Radialprofilieren oder Formenspektrum
                  {
                  ...
                  else if(Ist_IBF.Flag.Axial_Radialwalzen == 0) // Axialprofilieren
                  {
   ...
   case 0:     //----------------------------------------------------------------
         ...
         case 1:     // Aufruf der jeweilgen IBF-Module IBF-flex.Radial, IBF-Flex.Axial, Formenspektrum
                     ...
                     if(Ist_IBF.Flag.Axial_Radialwalzen == 0) // 0= Axialwalzen|1= Radialwalzen
					    ...
					    {
					 	while(1 == 1) {}
					 //		 	ibf_Schuessel::Main(Ist_IBF, Soll_IBF, Ist_Inter,Soll_Inter);
					     }
