 ...
 *           \link Def_IBF_Allgemein_SOLL \endlink
 *@todo Fall 0 wurde noch nicht zu den Doxygen Kommentaren hinzugefuegt
 */
...
//########## Hand- bzw. Automatiksteuerung ausgehend von Koppers Position bei Walzenstart ##########
   ...
   // Startposition für jeweilige Ringgeometrie in axpro.h eintragen?
      ...
      case -1:    // --------------------------------------------------
                  ...
                  /* Ths commend is just for tests */
                  std::cout << "reached case -1" << std::endl;
                  ...
                  {  
                    ...
                    if(Ist_IBF.Flag.Axial_Radialwalzen == 3) // es soll eine Schuessel gewalzt werden
                    {
                      Soll_IBF->Profilflag = 1;
                      /* direkt zu dem Teil springen, in dem die Schuessel
                       * gewalzt wird. Die Vorbereitungen dazu werden in
                       * selbiger Klasse getroffen*/
                    }
                    else {
                      std::cout << "Falscher case -> error 001" << std::endl;
                  ...
                  /* Ths commend is just for tests */
                  std::cout << "leaves case -1" << std::endl;
   ...
   case 0:     //----------------------------------------------------------------
               ...
               //Memoryflag=IBF_Allgemein.IBF_Allgemein.Profilflag;						//für Pausefunktion
                ...
                /* Ths commend is just for tests */
                std::cout << "reached case 0" << std::endl;
         ...
         case 1:     // Aufruf der jeweilgen IBF-Module IBF-flex.Radial, IBF-Flex.Axial, Formenspektrum
          ...
          else if(Ist_IBF.Flag.Axial_Radialwalzen == SCHUESSEL_WALZEN)
					  {
