 ...
 * @brief Geometrie eines Rohlings*/
    ...
    */
     ...
     * @brief Enth‰lt Informationen ¸ber den Zentrierarm und Rolle.
     * Diese Informationen umfassen Distanzen in dem Werkzeug, sowie den
     * Durchmesser der Zentrierrolle.
     */
    struct Def_Werkzeug_Zentrierarm_Rolle
    {
      /** @var dist_Hauptwalze_SenkrechteZentrierarmfixpunkt
       * @brief Distanz vom Ende der Hauptwalze bis zur Senkrechten der
       * Mittelachse des Walzwerks, welche durch den Fixpunkt des Zentrierarms
       * geht in [mm]*/
      int dist_Hauptwalze_SenkrechteZentrierarmfixpunkt;

      /** @var durchmesser_zr
       * @brief Radius der Zentrierrolle in [mm]*/
      int durchmesser_zr;

      /** @var dist_Mittelachse_Zentrierarmfixpunkt
       * @brief Distanz zwischen Fixpunkt des Zentrierarmes bis zum
       * Mittelpunkt des Walzwerks in [mm]*/
      int dist_Mittelachse_Zentrierarmfixpunkt;

      /** @var dist_Kolbenende_Zentrierarmfixpunkt
       * @brief Distanz vom Ende des Kolbens bis zum Fixpunkt des
       * Zentrierarmes in [mm]*/
      int dist_Kolbenende_Zentrierarmfixpunkt;

      /** @var dist_Fixpunkt_Zentrierrolle
       * @brief Distanz vom Fixpunkt des Zentrierarmes bis zum Mittelpunkt der
       * Zentrierrolle in [mm]*/
      int dist_Fixpunkt_Zentrierrolle;

      /** @var dist_Kolben_Zentrierarm
       * @brief Die Distanz vom Fixpunkt des Kolbens bis zur Senkrechten zur
       * Mittelachse, die durch den Fixpunkt des Zentrierarms geht. In [mm]*/
      int dist_Kolben_Zentrierarm;

      /** @var dist_Kolbenende_Zentrierrolle
       * @brief Die Distanz vom Ende des Kolbens bis zum Mittelpunkt der
       * Zentrierrolle */
      int dist_Kolbenende_Zentrierrolle;

      /** @var dist_Mittelachse_Kolbenfixpunkt
       * @brief Distanz zwischen der Mittelachse des Walzwerks und dem
       * Fixpunkt des Kolbens */
    ...
    struct Werkzeug
    {
        ...
        /** @var werkzeug_zr
         * @brief eine Struktur vom Typ 
         * \link Def_Werkzeug_Zentrierarm_Rolle \endlink f¸r den rechten
         * Zentrierarm */
        struct Def_Werkzeug_Zentrierarm_Rolle werkzeug_zr;

        /** @var werkzeug_zl
         * @brief eine Struktur vom Typ 
         * \link Def_Werkzeug_Zentrierarm_Rolle \endlink f¸r den linken
         * Zentrierarm */
