...
void stuetzstellen(struct Def_Ist_Inter Ist_Inter, struct Def_IBF_Allgemein_IST Ist_IBF, struct Def_IBF_Allgemein_SOLL *Soll_IBF)
{
						...
						//f_H = Ist_Inter.hw_n/(71*60); // Frequenz untere Kegelwalze, 60s/min, Getriebe 1:7.5, Drehzahlfaktoren nur für Modellwalzwerk separat notwendig! 
         	//Soll_IBF->stuetz_var.t_U = (float)(Ist_Inter.da/(Ist_Inter.Werkzeug.Durchmesser_HW*Ist_Inter.hw_n)); 
           //zunächst wird testweise 
           //Ist_Inter->Werkzeug.Ringumdrehung verwendet
					
          	// Zeit für eine Ringumdrehung gemessen in s
              ...
              //              Soll_IBF->stuetz_var.crtimer = (float)(1000*Ist_Inter.Werkzeug.Ringumdrehung / 100*maxstellen);   //Timer neu setzen. Faktor 1000 für Millisekunden statt Sekunden.
	...
	//Bedeutung _A_X_I_A_L_ mit konstantem Cr und KRAGENWALZE walzen (Kragenwalze verursacht andere gedrückte Länge als Kegelwalze)!
                    ...
                    //Falls cr nicht vorgegeben wird, wird dieses mit dem ersten Funtionsaufruf berechnet und entsprechend verwendet
               		if (Ist_IBF.stuetz_var.ca <= 0.001)	//Cr muss vorgegeben sein!
						...
						//Soll_IBF->ASO_Pos = delta_S -S0r = angestrebte axiale Wanddicke = Ziel dieser Berechnung!!!
