...
#include "iniFile.h"
    ...
    void Axialkraft(struct Def_IBF_Allgemein_IST Ist_IBF, struct Def_IBF_Allgemein_SOLL *Soll_IBF)
    {
      ...
      if(Ist_IBF.Flag.Axial_Radialwalzen == 0)
        {
            Soll_IBF->AS_Kraft  = Ist_IBF.Flag.as_kraftregler_aktiv  ? Soll_IBF->AS_Kraft_Vorgabe  : 390000.0F ;  // 1 T = 10.000 N -> 38 T = 380.000 N
        }
      else
        {
            Soll_IBF->AS_Kraft  = Ist_IBF.Flag.as_kraftregler_aktiv  ? Soll_IBF->AS_Kraft_Vorgabe  : 390000.0F ; // erhöht auf 38 Tonnen (08.11.2007)
        } 
    ...
    int RPW::IBFPARA_auslesen(struct Def_IBF_Allgemein_IST *Ist_IBF, struct Def_IBF_Allgemein_SOLL *Soll_IBF)
    {
         ...
         if(!iniFile.ReadFile()) //Fehlerbehandlung
         ...
         else 
           {
            ...
            Ist_IBF->ASO_Pos_Differenz        = iniFile.GetValueF( "IBF_Wahlschalter Axialprofilieren(0) Radialprofilieren(1)", "Starthoehendifferenz zu Carwin", 0);    
          ...
          //Einlesen der Schlüsselidentifikation
            ...
            Ist_IBF->Axial.Biss.Verhaeltnis      = iniFile.GetValueF( "IBF-Variablen Axialprofilieren - Bissverhaeltnis", "Bissverhaeltnis in Prozent", 0);
            Ist_IBF->Axial.Biss.Position         = iniFile.GetValueF( "IBF-Variablen Axialprofilieren - Bissverhaeltnis", "Position Innen(0) Außen(1)", 0);
            Ist_IBF->Axial.Biss.Anzahl           = iniFile.GetValueI( "IBF-Variablen Axialprofilieren - Bissverhaeltnis", "Anzahl der Bisse", 1);
