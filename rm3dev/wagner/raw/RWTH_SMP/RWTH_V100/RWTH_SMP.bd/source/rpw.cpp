                        ...
                        struct Def_Ist_Inter   *Ist_Inter)
{
   ...
   Ist_Inter->Vorform.sm      = Ein_Puff.vorform.sm;          /* Wandstärke Null                  [mm] */
   Ist_Inter->Vorform.da      = Ein_Puff.vorform.da;          /* Durchmesser Vorform                   */
               ...
               struct Def_IBF_Allgemein_SOLL *Soll_IBF)
{
   ...
   Ist_IBF->Wandstaerke_Null    = Ist_Inter.Vorform.sm; //Wandstärke aus Carwin  
   Ist_IBF->Werkzeugdurchmesser = diam_dw;  
   Ist_IBF->D_Null              = Ist_Inter.Vorform.da;                              

#if(MRAW)
   Ist_IBF->FA_f       = 0.1F;
   Ist_IBF->FR_f       = 0.1F;  // im Interfac gefiltert
   Ist_IBF->s_f        = 0.1F;
...
//---------------------------------------------------------------------------
   ...
   float uk = 0;              //Wert für Radialkraft
   float uk1 = 0;
   ...
   float Afpos_dw = 0.0F; // änderung der VAriablen "Anfahrposition_Dorn;" auf 8 Zeichen 	// Variable für Dornposition, nachdem dieser Positioniert woren ist   
...
//++++++++++ Zyklische Initialisierung und Aktualisierung der Messgrößen ++++++++++
   ...
   Soll_IBF->Soll_RS_V = Soll_IBF->Soll_ASO_V = Soll_IBF->Soll_AG_V = 1.0F;      //  !!!
   
   Soll_Inter->rs_v  = Soll_IBF->Soll_RS_V;
   Soll_Inter->ag_v  = Soll_IBF->Soll_AG_V;
   Soll_Inter->aso_v = Soll_IBF->Soll_ASO_V;
...
//########## Hand- bzw. Automatiksteuerung ausgehend von Koppers Position bei Walzenstart ##########
   ...
   if (! Ist_IBF->AUTO)		// AUTO = 0 heißt manuelle Steuerung
   {
      ...
      if (Ist_IBF->StartPos == 1)
      {
         ...
         Soll_IBF->Soll_RS_Pos  = Ist_IBF->RS_Pos;
         Soll_IBF->Soll_ASO_Pos = Ist_IBF->ASO_Pos;
         Soll_IBF->Soll_AG_Pos  = Ist_IBF->AG_Pos;
         
         // Sollgeschwindigkeiten im Walzwerk:
         Soll_IBF->Soll_RS_V = 100000.0F;
         Soll_IBF->Soll_ASO_V = 1.0F;
         Soll_IBF->Soll_AG_V = 1.0F;
      ...
      switch (Ist_IBF->ManAuswahl)
      {
         ...
         case 't': Soll_IBF->Soll_RS_Pos = Soll_IBF->Soll_RS_Pos - 0.2F;	break;	// Radialschlitten
         //case 'w': Soll_RS_Pos = Soll_RS_Pos - 0.1F;	break;
         case 'z': Soll_IBF->Soll_RS_Pos = Ist_IBF->RS_Pos; break;
         //case 'r': Soll_RS_Pos = Soll_RS_Pos + 0.1F;	break;
         case 'u': Soll_IBF->Soll_RS_Pos = Soll_IBF->Soll_RS_Pos + 0.2F; 	break;
         
         case 'd': Soll_IBF->Soll_AG_Pos = Soll_IBF->Soll_AG_Pos - 0.2F;	break;	//	Axialgerüst
         //case 's': Soll_AG_Pos = Soll_AG_Pos - 0.1F;	break;
         case 'f': Soll_IBF->Soll_AG_Pos = Ist_IBF->AG_Pos; break;
         //case 'f': Soll_AG_Pos = Soll_AG_Pos + 0.1F;	break;
         case 'g': Soll_IBF->Soll_AG_Pos = Soll_IBF->Soll_AG_Pos + 0.2F;	break;
         
         case 'y': Soll_IBF->Soll_ASO_Pos = Soll_IBF->Soll_ASO_Pos - 0.2F;	break;	//	Axialschlitten
         //case 'x': Soll_AS_Pos = Soll_AS_Pos - 0.1F;	break;
         case 'x': Soll_IBF->Soll_ASO_Pos = Ist_IBF->ASO_Pos; break;
         //case 'v': Soll_AS_Pos = Soll_AS_Pos + 0.1F;	break;
         case 'c': Soll_IBF->Soll_ASO_Pos = Soll_IBF->Soll_ASO_Pos + 0.2F;	break;
   ...
   {     // automatische Steuerung:
      ...
      case -1:    // --------------------------------------------------
                  ...
                  Soll_IBF->Soll_RS_V  = 0.0F;
                  Soll_IBF->Soll_ASO_V = 0.0F; 
                  Soll_IBF->Soll_ASU_V = 0.0F;
                  Soll_IBF->Soll_AG_V  = 0.0F;
                  ...
                  Soll_IBF->Soll_AG_Pos  = Soll_IBF->AG_Pos_Start = Ist_IBF->AG_Pos; // AG_Pos == auslesen der Werte aus PA-Karte inkl. Offset						
                  ...
                  Soll_IBF->ASO_Pos_Null = Ist_IBF->Start_Ringhoehe + 15.0F; 	
                  ...
                  //--------------------------------------------------------------------------------
                  //------------------Kalibrierung der Eingangsignale-> hier Radialkraft------------
                  //--------------------------------------------------------------------------------
                  Soll_Inter->zal_v=0.0F ; // michl: festsetzen der Zentrierarme !!! WENN ALLES FUNTZT, DANN RAUS
                  Soll_Inter->zar_v=0.0F ; // michl: festsetzen der Zentrierarme  
               ...
               Soll_IBF->Soll_RS_Pos = Soll_IBF->RS_Pos_Null; // definiert für RS_Pos in case 'a'
               break; //case -1
   ...
   case 0:     //----------------------------------------------------------------
               ...
               switch (Ist_IBF->InitAchse) 
                ...
                case 'a1':
                             ...
                             //Überprüfen, ob Dornposition erreicht ist
                            if(Ist_IBF->RS_Pos <= 100) // Ab hier wird Radialschlitten positionieren
                               {
                                  Soll_IBF->Soll_RS_V = 0.0F;
                  ...
                  case 'b1': 
                    ...
                    case 'a':  	
                              //_settextposition(9,19); printf("case a");
                             if(FALSE)
                             {
                             #ifdef MRAW
                                 _settextposition(10,1); printf("MAPW: RS_Pos %8.1f  Soll_RS_Pos %8.1f RS_Pos_Null%8.1f, gefilterter %8.1f", Ist_IBF->RS_Pos, Soll_IBF->Soll_RS_Pos, Ist_IBF->RS_Pos_Null, diam_f);										
                                 _settextposition(13,1); printf("Dorn%8.1f, Hauptwalze%8.1f, t_Halte%8.1f",diam_dw, diam_hw, t_Halte);
                             #endif
                             }
                          
                             Soll_IBF->Soll_AG_V  = 0.0F;
                             Soll_IBF->Soll_ASO_V = 5.0F; 
                             Soll_IBF->Soll_ASU_V = 0.0F;
                       ...
                       if(Radialkraft!= 0.0F)	//aus IBF-Para(Radv01) vorgegeben               	  
                        {  	
                             
                             
                                Soll_IBF->Soll_RS_V  = 7.0F;            // Dorn, Radialschlitten
                                Soll_Inter->rs_v = Soll_IBF->Soll_RS_V; // Übergebe Gechwindigkeit an Tabelle.....
                              
                                Soll_IBF->Soll_ASO_Pos = Ist_IBF->Start_Ringhoehe + 1.5F; //da Ring gerne klettert, wird bereits hier ASO zugestellt
                             									
                                if (Ist_IBF->RS_Pos <= (Ist_IBF->RS_Pos_Null + eps) && t_Halte >= 30)
                                 { 
                                   Soll_IBF->Soll_RS_Pos = Ist_IBF->RS_Pos_Null - n;
                                    n= n + 0.01F;
                                 }
                              //---------------------------------------------------------------------------------
                              ...
                              //---------------------------------------------------------------------------------
                               ...
                               { 
                                     ...
                                     if (t_Halte == 0)
                                     {
                                       Soll_IBF->Soll_RS_Pos = Ist_IBF->RS_Pos; // erreicht
                                       Soll_IBF->Soll_RS_V= 2.0F;
                               ...
                               else   break;   		//else Soll_RS_Pos = RS_Pos_Null + 0.2F - zaehler; break;
                         ...
                         if(Radialkraft == 0.0F)	
                           { 		
                                  ...
                                  Soll_IBF->Soll_RS_V  = 8.0F;            // Dorn, Radialschlitten
                                  Soll_Inter->rs_v = Soll_IBF->Soll_RS_V; //Übergebe Geschwindigkeit an Tabelle..
            
                                  Soll_IBF->Soll_RS_Pos = Soll_IBF->RS_Pos_Null;
                                  Soll_IBF->Soll_AG_Pos = Ist_IBF->Start_Ringhoehe + 1.5F; //da Ring gerne klettert, wird bereits hier ASO zugestellt..
 
                               if(Ist_IBF->RS_Pos <= Soll_IBF->Soll_RS_Pos) // Ab hier wird Radialschlitten positionieren
                               {
                                  Soll_IBF->InitAchse = 'b';
                  ...
                  case 'b':                   				
                              ...
                              n=0.1f;
                              Soll_IBF->Soll_AG_Pos = Ist_IBF->D_Null + diam_hw/2 - Ist_IBF->Pos_auf_Mantel - Ist_IBF->Del_Kr_AGR ;     // 10 steht für die Variable Pos_auf_Mantel
                              Soll_IBF->InitAchse ='c';
                              
                              break; // zu case 'b'

                  case 'c':   Soll_IBF->Soll_AG_V  = 10.0F;								// Axialgerüst 
                              Soll_IBF->Soll_RS_V  = 0.0F;
                              Soll_IBF->Soll_ASO_V = 5.0F; 
                              Soll_IBF->Soll_ASU_V = 0.0F;
                              ...
                              if (Soll_IBF->Soll_AG_Pos < (Ist_IBF->AG_Pos_Start))
                              {
                                 if (Ist_IBF->AG_Pos <= (Soll_IBF->Soll_AG_Pos + eps)) 
                                 {
                              ...
                              Soll_IBF->InitAchse = 'd'; // AG wird nicht positioniert darum rein   
                              break; // zu case 'c'
                  
                  case 'd':   //Hier die Position des oberen Axialschlittens programmieren....
                              
                              Soll_IBF->Soll_ASO_V = 5.0F;	 
                              Soll_IBF->Soll_ASU_V = 1.0F;
                              Soll_IBF->Soll_RS_V  = 0.0F;
                              Soll_IBF->Soll_AG_V  = 0.0F; 
                              ...
                              Afpos_dw = Ist_IBF->RS_Pos;     // Variable in der aktuelle Dornposition definiert ist nachdem Dorn positioniert worden ist
                              //    t_warte=10*diam_f/(diam_hw*f_H); // Hier t_warte definiert-> wird in case 1 benötigt
                              //--------------------------------------------------------------------------------------
                              //----------------Anfahren des Axialschlittens auf Kraft--------------------------------
                              //-------------------------------------------------------------------------------------- 
                              if(Axialkraft != 0.0F)  //wird nur durchlaufen, wenn Kraft angegeben
                              {
                                 #ifdef MRAW
                                    _settextposition(2,10);
                                    printf("ASO anhand Kraft");
                                 #endif
                                 Soll_IBF->Soll_ASO_Pos = Ist_IBF->Start_Ringhoehe - 10.0F;    //!!statt Zaehler wurde als Wert 10 (mm) eingesetzt;;;zaehler wurde in case'a' auf den Wert 0.5F gesetzt
                              ...
                              if(Axialkraft == NULL) //wird durchlaufen, wenn ohne Kraftsteuerung angefahren wird
                              { 
                                 Soll_IBF->Soll_ASO_Pos = Ist_IBF->Start_Ringhoehe;
                                 if (Ist_IBF->ASO_Pos <= (Soll_IBF->Soll_ASO_Pos + eps) || Ist_IBF->ASO_Pos <= (Soll_IBF->Soll_ASO_Pos - eps) ) 
         ...
         case 1:     //Vergleich der eingegebenen Wandstärke und der, per Kraftsteuerung angefahrenen Wandstärke
                     ...
                     s_ist = Afpos_dw - ((186.9F + Ist_IBF->Werkzeugdurchmesser)/2.0F);
                     ...
                     {Soll_IBF->Profilflag = 12; Soll_IBF->Soll_RS_Pos = Ist_IBF->RS_Pos - 0.5f; break;}
                     
                     if (Ist_IBF->Schalter_Kont_DisKo == 2) //diskontinuierlicher Vorschub (eps über Geschwindigkeit)
                     {
                        Soll_IBF->Profilflag =13; 
                        t_dis_h = 10*(Ist_IBF->D_Null/(diam_hw*f_H)); //Zeit für x Umdrehungen bei denen der Dorn in den Ring vorfährt bis Schnabel-Formel greift
                        break;
                     }
       ...
       case 11:      //Kontinuierlcher Walzungsroutine
                     ...
                     Soll_IBF->Soll_RS_V  = Soll_IBF->Vorschubgeschw_Dw;    // Dorn, Radialschlitten   
                     Soll_IBF->Soll_ASO_V = 100.0F;
                     Soll_Inter->rs_v = Soll_IBF->Soll_RS_V;        
                     Soll_Inter->ag_v = Soll_IBF->Soll_ASO_V;
                     Soll_Inter->aso_pos = 143.0F;
                     if(Soll_IBF->Steg != 0)   // Abfrage ob Stegstärke angegeben
                     {
                     Soll_IBF->Soll_RS_Pos = (diam_hw + Ist_IBF->Werkzeugdurchmesser)/2 + Soll_IBF->Steg;
                    
                     }
                     else Soll_IBF->Soll_RS_Pos = Afpos_dw - Soll_IBF->delta_s;  //Afpos_dw wird in case 0 -> case 'a' gesetzt.....
                     
                     Soll_IBF->Soll_RS_Pos = Ist_IBF->RS_Pos;
                    
                     if(Ist_IBF->RS_Pos <= Soll_IBF->Soll_RS_Pos || Ist_IBF->RS_Pos <= (Soll_IBF->Soll_RS_Pos + eps) || Ist_IBF->RS_Pos <= (Soll_IBF->Soll_RS_Pos - eps))
                     {	
                        t_Halte= Soll_IBF->Umdrehungen*10*(Ist_IBF->D_Null/(diam_hw*f_H));
                        //t_Halte=Umdrehungen*10*diam_f/(diam_hw*f_H); // n Umdrehungen, 10 * "100" ms Aufrufzyklus = 1000 ms = 1s;  
                        
                        Soll_IBF->Profilflag = 2; 
                        Soll_IBF->Soll_ASO_Pos = Ist_IBF->ASO_Pos; // damit kein Durck ausgeübt wird wenn Walzprozeß beendet ist muss hier noch eine Konstante eingefügt werden (z.B. 5)
                        break;
                        }                  
                    ...
                    if(Axialkraft != NULL)
                    {
                      ...
                      Soll_IBF->Soll_ASO_Pos = Ist_IBF->ASO_Pos;
                        ...
                        if(t_dis_h <=0)
                        {
                           ...
                           Soll_IBF->Soll_ASO_Pos = Soll_IBF->Soll_ASO_Pos_alt + delta_h;
                           
                           Soll_IBF->Soll_ASO_Pos_alt = Soll_IBF->Soll_ASO_Pos;  
                           s_f_alt = Ist_IBF->s_f;   
                           t_dis_h = 10*(Ist_IBF->D_Null/(diam_hw*f_H)); // 1 Umdrehungen (kein Wert vor der 10), 10*100 ms = 1000 ms = 1s
                        }        
       ...
       case 3:    //Memoryflag= Ist_IBF->Profilflag;
                  ...
                  {                         
                     ...
                     //Freigabe_MRAW_Senden();
                        ...
                        case 'a': 	
                              Soll_IBF->Soll_RS_Pos=Ist_IBF->RS_Pos_Start+10.0F; //michl
                              Soll_IBF->Soll_RS_V = 5.0F;
                              Soll_Inter->rs_v = Soll_IBF->Soll_RS_V;      
                              if (Ist_IBF->RS_Pos >= Soll_IBF->Soll_RS_Pos) Soll_IBF->ExitAchse = 'b';
                              break;
 
                        case 'b':
                   
                              Soll_IBF->Soll_AG_Pos = Ist_IBF->AG_Pos_Null  + 50; 
                              Soll_IBF->Soll_ASO_Pos= Ist_IBF->ASO_Pos_Null + 15; //michl
                              
                              Soll_IBF->Soll_ASO_V = 15.0F; 
                              Soll_Inter->aso_v = Soll_IBF->Soll_ASO_V;
                              
                              Soll_IBF->Soll_AG_V = 8.0F;
                              Soll_Inter->ag_v = Soll_IBF->Soll_AG_V;
                                                          	
                              Soll_Inter->zal_v=0.0F ; // michl: festsetzen der Zentrierarme
                              Soll_Inter->zar_v=0.0F ; // michl: festsetzen der Zentrierarme    
                              if (Ist_IBF->AG_Pos >= Soll_IBF->Soll_AG_Pos) 
                              {
                                 Soll_IBF->ExitAchse = ' '; 
                                 Soll_IBF->Profilflag++;
                              }
                              
                              if (     (Ist_IBF->RS_Pos  >= Soll_IBF->Soll_RS_Pos)
                                    && (Ist_IBF->ASO_Pos >= Soll_IBF->Soll_ASO_Pos)
                                    #ifdef MRAW
...
/*------------------------------------------------------------------------------------*/
      ...
      if (AG_RS != 0)
      {  
         Soll_Inter->ag_pos = Soll_IBF->Soll_AG_Pos + offset_agr;
         #ifdef MRAW
            _settextposition(7,1);
            printf("                                     ");
         #endif
      ...
      if (AS_AS != 0)
      {  
         Soll_Inter->aso_pos = Soll_IBF->Soll_ASO_Pos + offset_aso;
         #ifdef MRAW
