...
#include "iniFile.h"
    ...
    return  Ist_Inter.kw_ia * (Ist_Inter.Werkzeug.Durchmesser_HW * Ist_Inter.hw_n / Ist_Inter.da)
                            * (Ist_Inter.da/2 - Ist_IBF->Axial.AGR_Pr)
    ...
    {
      // Das Werkzeug zum Axialprofiliern bedarf einer Kraftbegrenzung von max. 40T (Setze zu Beginn Grenze auf 3T fest)

      // Los geht´s

      if(Ist_IBF.Flag.Axial_Radialwalzen == 0)
        {
            Soll_IBF->AS_Kraft  = Ist_IBF.Flag.as_kraftregler_aktiv  ? Soll_IBF->AS_Kraft_Vorgabe  : 30000.0F ;  // 1 T = 10.000 N
        }
      else
        {
            Soll_IBF->AS_Kraft  = Ist_IBF.Flag.as_kraftregler_aktiv  ? Soll_IBF->AS_Kraft_Vorgabe  : 80000.0F ; // 8 Tonnen bisher ausreichend
        } 
    ...
    void Anwalzen_Radial(struct Def_IBF_Allgemein_IST Ist_IBF, struct Def_IBF_Allgemein_SOLL *Soll_IBF) 
     {
        ...
        //Soll_IBF->AS_Kraft  = Ist_IBF.Flag.as_kraftregler_aktiv  ? Soll_IBF->AS_Kraft_Vorgabe  :  80000.0F ; 
        Axialkraft(Ist_IBF, &*Soll_IBF);
        Soll_IBF->AG_Kraft  = Ist_IBF.Flag.ag_kraftregler_aktiv  ? Soll_IBF->AG_Kraft_Vorgabe  :  10000.0F ; //1 T = 10.000 N
        Soll_IBF->ZAR_Kraft = Ist_IBF.Flag.zal_kraftregler_aktiv ? Soll_IBF->ZAL_Kraft_Vorgabe :  10000.0F ; 
        Soll_IBF->ZAL_Kraft = Ist_IBF.Flag.zar_kraftregler_aktiv ? Soll_IBF->ZAR_Kraft_Vorgabe :  10000.0F ;
        ...
        if (Ist_IBF.Flag.rs_kraftanfahren_aktiv == 1) // Schalter: Walzen mit Kraftsteuerung 'AN' 
         {
           Soll_IBF->RS_Kraft = Ist_IBF.Flag.rs_kraftanfahren_aktiv ? Soll_IBF->RS_Kraft_Anfahren : 40000.0F ;
         }
        else
           Soll_IBF->RS_Kraft = Ist_IBF.Flag.rs_kraftregler_aktiv ? Soll_IBF->RS_Kraft_Vorgabe: 40000.0F;                                         
     }
    ...
    int AGR_Pr_Wanddicken_Verhaeltnis_proz(struct Def_Ist_Inter Ist_Inter, struct Def_IBF_Allgemein_IST Ist_IBF)
    {
        ...
        Ist_IBF.Axial.Verh_pr_sf_proz_start = (Ist_IBF.Axial.AGR_Pr/Ist_IBF.Vorring.Wandstaerke_Null) * 100.0F; // Verhältnis bei Walzstart
        Ist_IBF.Axial.Verh_pr_sf_proz       = (Ist_IBF.Axial.AGR_Pr/Ist_Inter.s0a) * 100.0F;                    // Verhältnis während Walzung
        return TRUE;
    }
    ...
    char AGR_Nachfuehr_Entscheider(struct Def_Ist_Inter Ist_Inter, struct Def_IBF_Allgemein_IST Ist_IBF, struct Def_IBF_Allgemein_SOLL *Soll_IBF)
    {
        ...
        AGR_Pr_Wanddicken_Verhaeltnis_proz(Ist_Inter, Ist_IBF);

        if(Ist_IBF.Axial.Verh_pr_sf_proz <= 60.0F) //Proflposition befindet sich vom äußeren Randbereich auf min. 60% der Wanddicke
            {
                Soll_IBF->Axial.Wert = 'A';
                Wert = 'A';
            }
        else if(Ist_IBF.Axial.Verh_pr_sf_proz > 60.0F) //Proflposition befindet sich vom äußeren Randbereich über 60% der Wanddicke
            {
    ...
    int RPW::IBFPARA_auslesen(struct Def_IBF_Allgemein_IST *Ist_IBF, struct Def_IBF_Allgemein_SOLL *Soll_IBF)
    {
         ...
         if(!iniFile.ReadFile()) //Fehlerbehandlung
          ...
          //Einlesen der Schlüsselidentifikation
            ...
            Ist_IBF->Axial.AGR_Pr                 = iniFile.GetValueF( "IBF-Variablen Axialprofilieren - Walzparameter", "Profilposition von Außenrand", 1500);
