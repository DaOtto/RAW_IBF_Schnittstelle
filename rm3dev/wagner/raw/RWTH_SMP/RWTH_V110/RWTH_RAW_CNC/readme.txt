========================================================================
    MAKEFILE-PROJEKT: RWTH_RAW_CNC-Projektübersicht
========================================================================

Dieses RWTH_RAW_CNC-Projekt wurde vom Anwendungs-Assistenten 
für Sie erstellt.
...
Mit diesem Projekt können Sie aus Visual Studio heraus erstellen/bereinigen/neu 
erstellen, indem Sie die im Assistenten eingegebenen Befehle aufrufen. Als 
Erstellungsbefehl kann nmake oder ein anderes Tool Ihrer Wahl verwendet werden.

Da dieses Projekt keine Dateien enthält, werden im Projektmappen-Explorer keine 
Dateien angezeigt.
