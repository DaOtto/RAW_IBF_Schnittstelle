...
public:
	...
	uint* get_pCountBlinker(void)
	{
		return (&CountBlinker);
	} //Test Logger
	uint* get_pBlinker(void)
	{
		return (&Blinker);
	}           //Test Logger
...
private:
	Def_Ist_Inter			Ist_Inter_Ini;
	Def_Soll_Inter			Soll_Inter_Ini;
	Def_IBF_Allgemein_SOLL	Soll_IBF_Ini;
	Def_IBF_Allgemein_IST	Ist_IBF_Ini;
};
