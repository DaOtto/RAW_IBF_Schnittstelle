...
/*-----------------------------------------------------------------------------------------*/
  ...
  struct Cr_Berechnung
	...
	int Profilflag;
        ...
        /** @var t_dis_h
         * @brief Haltezeit für diskontinuierliche Walzung*/
        float t_dis_h;               
        /** @var Umdrehungen
         * @brief Anzahl der Umdrehungen in der Rundungsphase aus IBF_Para.ini*/
        int Umdrehungen;
        /** @var t_warte
         * @brief Wartezeit*/
        float t_warte;               
        ...
        /** @var s_f_Filter
         * @brief Struktur eines Filters mit aktuellen Wandpositionen für sehr kleine Positionierungen*/
         ...
         * @brief Position die der Dorn angefahren hat, um Zustellung für erste Ringumdrehung zu berechen (MRW -> Afpos_dw) in [mm]*/
        ...
        /** @var Rohlinghoehe
         * @brief Variable wird für Axialschlittenposition benötigt aus IBF_Data.ini in [mm]*/
        float Rohlinghoehe;        
        ...
        /** @var eps_Vorschub
         * @brief Epsilon fuer disk. Vorschub über Weg*/
        float eps_Vorschub;        
        ...
        /** @var Walzspalt_Cr
         * @brief Walzspaltverhältnis aus IBF_Data.ini*/
        float Walzspalt_Cr;          
