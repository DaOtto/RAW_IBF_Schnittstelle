...
int RPW::flexibel_Axial(struct Def_Ist_Inter& Ist_Inter, struct Def_IBF_Allgemein_IST& Ist_IBF,
						struct Def_Soll_Inter& Soll_Inter, struct Def_IBF_Allgemein_SOLL& Soll_IBF)
{
	...
	case 12:
		...
		if (Ist_IBF.ASO_Pos >= Soll_IBF.ASO_Pos - 1.0F)
		{
			...
			if (Ist_IBF.Flag.Bissverhaeltnis == 1) // Walzen mit Bissverhältnis / Bissversatz
			{
				...
				{
					if ((Ist_IBF.Axial.Turbine.Turbinenscheibe == 1) && (Ist_IBF.Axial.Turbine.zweite_Ebene_erreicht ==
																		 0))
					{
	...
	case 13:
		/* Positionieren des Axialgerüstes anhand des vorgegebenen Bissverhältnisses  */
		...
		{
			Soll_IBF.AG_Pos = Soll_IBF.Axial.Biss.AG_Pos_alt - (Ist_IBF.Axial.Kr_geo.Kr_Br / 100.0F *
																Ist_IBF.Axial.Biss.Verhaeltnis);
		}
	...
	case 14:
		/* Positionieren des Axialgerüstes für zweite Ebene beim Turbinenwalzen an Außendurchmesser*/
