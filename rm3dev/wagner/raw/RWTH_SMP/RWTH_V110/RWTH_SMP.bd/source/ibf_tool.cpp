...
float KW_Drehzahl_axial(struct Def_Ist_Inter Ist_Inter, struct Def_IBF_Allgemein_IST* Ist_IBF)
{
	...
	return Ist_Inter.kw_ia * (Ist_Inter.Werkzeug.Durchmesser_HW * Ist_Inter.hw_n / Ist_Inter.da)
		* (Ist_Inter.da / 2 - Ist_IBF->Axial.AGR_Pr[Ist_IBF->Axial.Pr_Num])
		/ ((Ist_IBF->Axial.Kr_geo.Del_Kr_AGR + Ist_IBF->Axial.Kr_geo.Kr_Br / 2)
...
float KW_Drehzahl_unten(struct Def_Ist_Inter Ist_Inter, struct Def_IBF_Allgemein_IST* Ist_IBF)
{
	...
	//   return(Ist_Inter.kw_ia/Ist_Inter.hw_ir * (Ist_Inter.Werkzeug.Durchmesser_HW * Ist_Inter.hw_n/2.0F)/((Ist_IBF->Del_Kr_AGR + Ist_IBF->Pos_auf_Mantel)*Ist_Inter.sin_kw_winkel_halbe));
	return 1;
}
...
/** Funktion, mit der die Betriebsarten von Radialschlitten und Axialschlitten festgelegt werden 
 * @param [in] Ist_IBF eine Strukutr vom Typ 
 * \link Def_IBF_Allgemein_IST \endlink
...
void rs_aso_mode(struct Def_IBF_Allgemein_IST Ist_IBF, struct Def_IBF_Allgemein_SOLL* Soll_IBF, int Funktionswahl)
{
	...
	case 1:
		...
		// Radialschlitten
		Soll_IBF->Flag.rs_mode  = (Ist_IBF.Flag.rs_kraftanfahren_aktiv || Ist_IBF.Flag.rs_kraftregler_aktiv)?1:0;

		// Axialschlitten
		Soll_IBF->Flag.aso_mode = (Ist_IBF.Flag.as_kraftanfahren_aktiv || Ist_IBF.Flag.as_kraftregler_aktiv)?1:0;
		break;
	...
	default:
		...
		// Radialschlitten
		Soll_IBF->Flag.rs_mode  = (Ist_IBF.Flag.rs_kraftregler_aktiv)?1:0;

		// Axialschlitten
		Soll_IBF->Flag.aso_mode = (Ist_IBF.Flag.as_kraftregler_aktiv)?1:0;
...
void Axialkraft(struct Def_IBF_Allgemein_IST Ist_IBF, struct Def_IBF_Allgemein_SOLL* Soll_IBF)
{
	...
	switch (Ist_IBF.Flag.Axial_Radialwalzen)
	{
		...
		default: // Alles andere...
			...
			Soll_IBF->AS_Kraft = Ist_IBF.Flag.as_kraftregler_aktiv  ? Soll_IBF->AS_Kraft_Vorgabe  :  80000.0F; // 10% 
			break;
	};
...
{
	// Vorgabe der Drücke unter Berücksichtigung der Betriebsart Vorschubs-, Kraftsteuerung
	...
	Soll_IBF->RS_Kraft	= Ist_IBF.Flag.rs_kraftregler_aktiv  ? Soll_IBF->RS_Kraft_Vorgabe  : 100000.0F;   // 10 T = 100.000 N = 100 kN
...
/** @fn IBF_Abschaltung
* @brief Öffnet das Walzwerk automatisch, wenn die Abschaltmasse erreicht werden.
...
void IBF_Abschaltung(struct Def_Soll_Inter* Soll_Inter, struct Def_IBF_Allgemein_IST Ist_IBF)
{
	...
	// Funktioniert derzeit noch nicht 24.07.07 D.Michl
...
void Breitungsexp(struct Def_IBF_Allgemein_IST Ist_IBF, struct Def_IBF_Allgemein_SOLL* Soll_IBF)
{
	...
	//Breitungsexponent 
	Soll_IBF->Radial.Breitung.mr = -0.00954F + 0.03397F * Soll_IBF->Radial.Walzspalt_Cr + 0.00253F *
		Soll_IBF->Radial.Breitung.qf + 0.1556F * Soll_IBF->Radial.Breitung.ga;
...
*/
void Durchme_t2(struct Def_Ist_Inter Ist_Inter, struct Def_IBF_Allgemein_IST Ist_IBF,
...
void Volumenbestimmung(struct Def_IBF_Allgemein_IST Ist_IBF, struct Def_IBF_Allgemein_SOLL* Soll_IBF)
{
	...
	/* verdrängtes Volumen*/
	Soll_IBF->Radial.Breitung.Volumen_diff = Soll_IBF->Radial.Breitung.Volumen_t1 - Soll_IBF->Radial.Breitung.
		Volumen_t2;
}
...
* @param[in] Ist_Inter eine Struktur vom Typ \link Def_Ist_Inter \endlink
* @param[in] Ist_IBF eine Struktur vom Typ \link Def_IBF_Allgemein_IST \endlink
* @param[in] *Soll_IBF ein Zeiger auf eine Struktur 
* \link Def_IBF_Allgemein_SOLL \endlink
*/
void Hoehenzunahme(struct Def_Ist_Inter Ist_Inter, struct Def_IBF_Allgemein_IST Ist_IBF,
				   struct Def_IBF_Allgemein_SOLL* Soll_IBF)
{
	...
	Soll_IBF->Radial.Breitung.delta_h = 12 * Soll_IBF->Radial.Breitung.Volumen_diff
		/ (PI * ((Soll_IBF->Radial.Breitung.Da_t2_h2
									   ...
									   struct Def_IBF_Allgemein_SOLL* Soll_IBF)
{
	...
	Soll_IBF->Axial.Verh_pr_sf_proz_start = (Ist_IBF.Axial.AGR_Pr[Ist_IBF.Axial.Pr_Num] /
											 Ist_IBF.Vorring.Wandstaerke_Null) * 100.0F; // Verhältnis bei Walzstart
...
char AGR_Nachfuehr_Entscheider(struct Def_Ist_Inter Ist_Inter, struct Def_IBF_Allgemein_IST Ist_IBF,
							   struct Def_IBF_Allgemein_SOLL* Soll_IBF)
{
...
float AGR_Soll_Pos(struct Def_Ist_Inter Ist_Inter, struct Def_IBF_Allgemein_IST Ist_IBF,
				   struct Def_IBF_Allgemein_SOLL* Soll_IBF)
{
...
/** Berechnet die Sollposition der Tastrolle, sowie die Differenz zwischen Soll- und
  * Istposition der Tastrolle
  * @param[in] Ist_Inter eine Struktur vom Typ \link Def_Ist_Inter \endlink
  * @param[in] Ist_IBF eine Struktur vom Typ \link Def_IBF_Allgemein_IST \endlink
  * @param[in] *Soll_IBF ein Zeiger auf eine Struktur vom Typ 
  * \link Def_IBF_Allgemein_SOLL \endlink
  */
void AGR_Soll_Pos_delta_Tr(struct Def_Ist_Inter Ist_Inter, struct Def_IBF_Allgemein_IST Ist_IBF,
						   struct Def_IBF_Allgemein_SOLL* Soll_IBF)
{
	//float delta_tr;
						  ...
						  struct Def_Ist_Inter& Ist_Inter)
{
	...
	else
	{
		...
		iniFile.NumValues("IBF_Wahlschalter Axialprofilieren(0) Radialprofilieren(1) Formenspektrum(2) Schuessel(3)");
		Ist_IBF.Flag.Axial_Radialwalzen = iniFile.GetValueI("IBF_Wahlschalter Axialprofilieren(0) Radialprofilieren(1) Formenspektrum(2) Schuessel(3)","Schalter_Profilflag", 0);
		Ist_IBF.ASO_Pos_Differenz = iniFile.GetValueF("IBF_Wahlschalter Axialprofilieren(0) Radialprofilieren(1) Formenspektrum(2) Schuessel(3)","Starthoehendifferenz zu Carwin", 0);
		...
		Soll_IBF.DRA_Kraft_Vorgabe = iniFile.GetValueF("IBF_Vorgabe Kraft", "DRA_Kraftvorgabe", 2000.0);
		Soll_IBF.DRE_Kraft_Vorgabe = iniFile.GetValueF("IBF_Vorgabe Kraft", "DRE_Kraftvorgabe", 2000.0);
		...
		Ist_IBF.Radial.Schalter_Kont_DisKo = iniFile.GetValueI("IBF-Variablen Radialprofilieren","Vorschubsart (0->const_Vorschub 1->Epsilon/Weg 2->mit Walzspaltverhaeltnis Cr)", 0);
		...
		Soll_IBF.Radial.eps_Vorschub = iniFile.GetValueF("IBF-Variablen Radialprofilieren","Epsilon fuer Auswahl 'Epsilon/Weg'", 0);
		Soll_IBF.Radial.Walzspalt_Cr = iniFile.GetValueF("IBF-Variablen Radialprofilieren", "Walzspaltverhaeltnis Cr", 0);
		...
		Ist_IBF.Axial.AGR_Pr[0] = iniFile.GetValueF("IBF-Variablen Axialprofilieren - Walzparameter","1. Profilposition von Aussenrand", 0);
		Ist_IBF.Axial.Pr_Tiefe[0] = iniFile.GetValueF("IBF-Variablen Axialprofilieren - Walzparameter","1. Profiltiefe", 0);
		Ist_IBF.Axial.AGR_Pr[1] = iniFile.GetValueF("IBF-Variablen Axialprofilieren - Walzparameter","2. Profilposition von Aussenrand", 0);
		Ist_IBF.Axial.Pr_Tiefe[1] = iniFile.GetValueF("IBF-Variablen Axialprofilieren - Walzparameter","2. Profiltiefe", 0);
		Ist_IBF.Axial.AGR_Pr[2] = iniFile.GetValueF("IBF-Variablen Axialprofilieren - Walzparameter","3. Profilposition von Aussenrand", 0);
		...
		Ist_IBF.Axial.Biss.Position = iniFile.GetValueI("IBF-Variablen Axialprofilieren - Bissverhaeltnis","Position Aussen-Innen(0) Innen-Aussen(1)", 0);
		...
		Ist_IBF.Axial.AGR_Pr[3] = iniFile.GetValueF("IBF-Variablen Axialprofilieren - Turbinenscheibe ACHTUNG erste Ebene mit Bissver ACHTUNG","1. Profilposition von Aussenrand in mm", 0);
		...
		iniFile.NumValues("IBF-DA Jenkouk - Analyse Axialgeruest");
		Ist_IBF.Flag.DA_Jenkouk_AG_Analyse = iniFile.GetValueI("IBF-DA Jenkouk - Analyse Axialgeruest","Ausschalten(0) Einschalten(1)", 0);
		Ist_IBF.AG_Regelung.Sprunghoehe = iniFile.GetValueF("IBF-DA Jenkouk - Analyse Axialgeruest", "Sprunghoehe", 0);
		Ist_IBF.AG_Regelung.Haltezeit = iniFile.GetValueF("IBF-DA Jenkouk - Analyse Axialgeruest", "Haltezeit", 0);
		...
		Ist_IBF.Formen.Profilflag = iniFile.GetValueI("IBF-Variablen Formenspektrum - Goldbach", "formen_profilflag",0);
		...
		// Informationen zu #Schuesselwalzen
		// Defaults entsprechen den Massen des Kalibrirringes (->sm=145mm)
		iniFile.NumValues("IBF-Variablen Schuesselwalzen");
		Ist_IBF.Schuessel.eps					=	iniFile.GetValueF("IBF-Variablen Schuesselwalzen","eps"					,1.0F		);

		Ist_IBF.Schuessel.Vorform.Masse_kg		=	iniFile.GetValueF("IBF-Variablen Schuesselwalzen","Vorform_Masse_kg"	,251.063F	);
		Ist_IBF.Schuessel.Vorform.Dichte_warm	=	iniFile.GetValueF("IBF-Variablen Schuesselwalzen","Vorform_Dichte_warm"	,7.430F		);
		Ist_IBF.Schuessel.Vorform.da_mm			=	iniFile.GetValueF("IBF-Variablen Schuesselwalzen","Vorform_da_mm"		,600.0F		);
		Ist_IBF.Schuessel.Vorform.hm_mm			=	iniFile.GetValueF("IBF-Variablen Schuesselwalzen","Vorform_hm_mm"		,90.0F		);

		Ist_IBF.Schuessel.Endform.Ende_h_min_mm			=	iniFile.GetValueF("IBF-Variablen Schuesselwalzen","Ende_h_min_mm"		,40.1F		);
		Ist_IBF.Schuessel.Endform.Ende_alpha_grad		=	iniFile.GetValueF("IBF-Variablen Schuesselwalzen","Ende_alpha_grad"		,9.1F		);
		Ist_IBF.Schuessel.Endform.Ende_max_Kletterhoehe	=	iniFile.GetValueF("IBF-Variablen Schuesselwalzen","Ende_max_Kletterhoehe",300.0F	);
		Ist_IBF.Schuessel.Endform.erreicht				=	0;

		Ist_IBF.Schuessel.n_HW					=	iniFile.GetValueF("IBF-Variablen Schuesselwalzen","n_HW"				,0.33334F	);
		Ist_IBF.Schuessel.V_Soll_AS				=	iniFile.GetValueF("IBF-Variablen Schuesselwalzen","V_Soll_AS"			,0.612F		);

		Ist_IBF.Schuessel.offset_DW				=	iniFile.GetValueF("IBF-Variablen Schuesselwalzen","offset_DW"			,10.1F		);
		Ist_IBF.Schuessel.offset_ZEN			=	iniFile.GetValueF("IBF-Variablen Schuesselwalzen","offset_ZEN"			,20.1F		);
		Ist_IBF.Schuessel.offset_DrR_A			=	iniFile.GetValueF("IBF-Variablen Schuesselwalzen","offset_DrR_A"		,-10.1F		);
		Ist_IBF.Schuessel.F_Soll_DrR			=	iniFile.GetValueF("IBF-Variablen Schuesselwalzen","F_Soll_DrR"			,20000.1F	);
		Ist_IBF.Schuessel.F_Grenz_DrR			=	iniFile.GetValueF("IBF-Variablen Schuesselwalzen","F_Grenz_DrR"			,100000.1F	);
		
		Ist_IBF.Schuessel.Test.Flag_oRing		=	iniFile.GetValueI("IBF-Variablen Schuesselwalzen","Test_Flag_oRing"		,1			);
		Ist_IBF.Schuessel.Test.Tastrolle_da		=	iniFile.GetValueF("IBF-Variablen Schuesselwalzen","Test_Tastrolle_da"	,600.1F		);

		iniFile.NumValues("Druckrollen Geometrie");
		Ist_IBF.DRR_Param.Dist_VK_NUL_A			=	iniFile.GetValueF("Druckrollen Geometrie","dra_offset"			,342.51F	);
		Ist_IBF.DRR_Param.Dist_VK_NUL_E			=	iniFile.GetValueF("Druckrollen Geometrie","dre_offset"			,345.91F	);
