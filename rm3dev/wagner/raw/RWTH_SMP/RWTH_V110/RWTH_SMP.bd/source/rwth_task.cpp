...
//  function:    RWTH Task                                       
/****************************************************************************/
/** Das Programm, welches von der Maschine abgespielt wird und nach welcher
 * sie sich verhält
 * 
 * Diese Methode wird als ein Programm an das Walzwerk weitergegeben. In ihr
 * werden die Methoden RWTH_EXCH::get_puff(), RWTH_EXCH::Main_Control()
 * so wie RWTH_EXCH::put_puff() aufgerufen. Der Teil dieser Methode, welcher
 * das Walzwerk steuert, bzw neue Sollwerte generiert befindet sich in der
 * Methode RWTH_EXCH::Main_Control().
 */
void _FAR RWTH_Task(void)
{
