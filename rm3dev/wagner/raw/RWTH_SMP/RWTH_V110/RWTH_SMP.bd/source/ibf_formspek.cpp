...
int RPW::formenspektrum(struct Def_Ist_Inter& Ist_Inter, struct Def_IBF_Allgemein_IST& Ist_IBF,
	...
	case 1:
		...
		*/
		...
		if (Ist_IBF.Zeit.t_Halte <= 0.0F)
		{
			...
			*/
			Soll_IBF.Zeit.t_Halte = (float)(10 * (Ist_Inter.da) / ((Ist_Inter.Werkzeug.Durchmesser_HW) * (Ist_Inter.
																										  hw_n))); // Berechnen der Haltezeit für 1 Ringumdrehung und Übergabe an IBF-Struktur 
		}
		/*Zähler - Merker*/
		Soll_IBF.Zeit.t_Halte--;


		if (Ist_IBF.Formen.proz_s <= 0)
			Soll_IBF.Formen.proz_s = 0.0F;       //Begrenzung auf Zahl zwischen 0 und 94 (0%-94% Abnahme)
		if (Ist_IBF.Formen.proz_s >= 94)
			Soll_IBF.Formen.proz_s = 94.0F;
