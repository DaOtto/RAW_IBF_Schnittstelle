...
//#ifdef _DEBUG
//	  cout <<" VN: "<<valuename<<" V: "<<value<<endl;
//#endif
...
/** Liest einen speziellen Wert aus der CIniFile aus.
 *
 * Der Wert der ausgelesen wird, muss durch die Parameter keyname und valuename
 * defferenziert werden. Durch "keyname" wird hier eine grobe Unterteilung in
 * Rubriken gemacht. Die Spezifizierung in einer Rubrik wird dann durch "valuename"
 * vorgenommen.
 * @param keyname Name der Rubrik, aus welcher der Wert ausgelesen werden soll
 * @param valuename Name der Variable, die innerhalb einer Rubrik ausgelesen werden
 * soll
 * @param defValue Standard Wert, falls kein Wert ausgelesen wurde
 * @return */
...
float CIniFile::GetValueF(string const keyname, string const valuename, double const defValue) const
{
	char svalue[MAX_VALUEDATA];

	sprintf(svalue, "%f", defValue);
	return (float)atof(GetValue(keyname, valuename, svalue).c_str());
}


unsigned CIniFile::GetValueV(string const keyname, string const valuename, char* format, void* v1, void* v2, void* v3,
							 void* v4, void* v5, void* v6, void* v7, void* v8, void* v9, void* v10, void* v11,
							 void* v12, void* v13, void* v14, void* v15, void* v16)
{
	string value;
	unsigned nVals;
