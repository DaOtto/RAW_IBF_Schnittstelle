...
//---------------------------------------------------------------------------
   ...
   #define PROF_ANZ_MAX 6
    ...
    struct Def_Biss_Ver
    {
        float Verhaeltnis;          // Bissverhältnis für breite Profile                                    [%]
        float AG_Pos_alt;           // Merker der vorherige Axialgerüstposition                             [mm]
        ...
        float AGR_Pr_Merker;        // Zahlen-Merker der in IBFPare.ini vorgebenen Axialgerüstposition [0] für Neustart [mm]
        int AG_Pos_Erreicht;        // Merker für Positonierung des AG in case 13 (Profilflag.Axial....)
    ...
    struct Def_Turbine
    {
        ...
        int AG_Pos_Erreicht;         // Neuposition für zweite Ebende
    ...
    struct Axial_Flex_Prof
    {
        ...
        int Profilflag;                 // Profilflag für die Funktion Axialprofilieren
        ...
        struct Def_Biss_Ver Biss;       // Struktur Bissverhältnis
