...
#ifndef SMP16
   #define WP_GES_MAX (WP_ANBINDUNG_ANFANG_MAX+WP_KONTUR_I_MAX+WP_KONTUR_A_MAX+WP_ANBINDUNG_ENDE_MAX)
#endif
   ...
   typedef struct Def_Halber_Querschnitt_CNC
   {
...
#ifndef SMP16
      struct Def_dxyz WP_ges[WP_GES_MAX];
      double Radien[WP_KONTUR_I_MAX+WP_KONTUR_A_MAX];
#endif
   } Def_Halber_Querschnitt;
...
#ifndef SMP16
      struct Def_dxyz WP[4 * WP_GES_MAX];
#endif
   };

   typedef Def_Querschnitt_CNC Def_Querschnitt;
