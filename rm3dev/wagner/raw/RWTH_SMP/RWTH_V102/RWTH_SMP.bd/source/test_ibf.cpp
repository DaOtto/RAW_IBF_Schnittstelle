...
void TEST_IBF::WRITE_VALUES(long * TestDat, char * TestString, int SizeString)
{
   ...
   case 5: // 
        ...
        TestDat[6] = Ist_Inter.Werkzeug.Frequenz_HW * 100;
   ...
   case 10: // 
        ...
        TestDat[5] = Soll_IBF.RS_Pos         * 100;             // [1/100 mm/s]
   ...
   case 11: // 
        ...
        TestDat[5] = aus_onli.Ibf_nominal.Soll_AS_Pos * 100;    // [1/100 mm/s]
        TestDat[6] = 0;
        TestDat[7] = 0;
        TestDat[8] = Ist_IBF.Flag.as_kraftregler_aktiv;
        TestDat[9] = Ist_IBF.Flag.as_kraftanfahren_aktiv;
        break;
   ...
   case 12: // 
        ...
        TestDat[5] = Soll_IBF.AG_Pos         *100;  
        TestDat[6] = Ist_IBF.AG_Pos_Start        *100;
        TestDat[7] = aus_onli.Ibf_nominal.AG_mode;
        TestDat[8] = aus_onli.Ibf_nominal.Soll_AG_Pos;
        TestDat[9] = Soll_Inter.ag_pos * 100;
        break;
   ...
   case 13: // 
        ...
        TestDat[6] = Soll_Inter.zar_kraft;  
   ...
   case 14: // 
        ...
        TestDat[5] = Soll_Inter.zal_kraftregler_aktiv;  
        TestDat[6] = 0;
        TestDat[7] = 0;
        TestDat[8] = 0;
        TestDat[9] = 0;
   ...
   case 15: // 
        ...
        TestDat[6] = Ist_Inter.Werkzeug.Frequenz_HW *1000;
   ...
   case 17: // 
    ...
    case 19: //
        strncpy(TestString, "AG-Gerüst Test", SizeString);
