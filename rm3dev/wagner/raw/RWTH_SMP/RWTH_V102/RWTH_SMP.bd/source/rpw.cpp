...
in Version V101 noch aktiv */
    ...
    hw_ir                =   Ein_Puff.hw1_motor.getriebe_untersetzung;              /* Getriebeuntersetzung Hauptwalzenmotor  i= n_Antrieb/n_Abtrieb (i>1 ist Untersetzung) */
    ...
    Ist_Inter->hw_n      =   Ein_Puff.n_hw_motor_ist  / hw_ir ;                  /* Istdrehzahl Hauptwalze              [1/s]  */
    Ist_Inter->kwo_n     =   Ein_Puff.n_awo_motor_ist / kw_ia ;                  /* Istdrehzahl Axialwalzen oben        [1/s] */        
    Ist_Inter->kwu_n     =   Ein_Puff.n_awu_motor_ist / kw_ia;                   /* Istdrehzahl Axialwalzen unten Debye->[1/s]_ohne_  /MIN_FAK || MRAW->[1/min]*/
               ...
               struct Def_IBF_Allgemein_SOLL *Soll_IBF)
{
   ...
   Ist_IBF->AG_Pos   = Ist_Inter.ag_pos;           // aktuelle Axialgerüstposition
   Ist_IBF->ASO_Pos  = Ist_Inter.aso_pos;          // aktuelle Axialschlittenposition oben
   ...
   //Ist_IBF->Radial.s_f          = Ist_Inter.s1r;          /* Aktuelle Wandstärke für Radialprofilieren         [mm] */ 
   ...
   //Ist_IBF->Zeit.Ringumdrehung  = Ist_Inter.da / (Ist_Inter.Werkzeug.Durchmesser_HW * Ist_Inter.Werkzeug.Frequenz_HW); // Zeit für eine Ringumdrehung gemessen in s
...
//########## Hand- bzw. Automatiksteuerung ausgehend von Koppers Position bei Walzenstart ##########
   ...
   {     // automatische Steuerung:
      ...
      case -1:    // --------------------------------------------------
                  ...
                  /* Betriebsmodi*/
                  Soll_Inter->ag_mode = Soll_IBF->Flag.ag_mode = 0; //Vorschub, Position nicht erreicht, SMS-Vorgabe
   ...
   case 0:     //----------------------------------------------------------------
               ...
               switch (Ist_IBF->InitAchse) 
                  {
                    ...
                    // Programmexample for interface-testing 
                    ...
                    case 'v':   Soll_IBF->Zeit.t_Halte--;
                                //Soll_IBF->Flag.ag_mode = 4; //Vorschub, Position nicht erreicht, IBF-Vorgabe
                                //Soll_IBF->Flag.ag_act = 1;
                    ...
                    case 'w':
                            ...
                            if(Soll_IBF->Zeit.t_Halte == 0)
                                {
                                   //Modus_AG(*Ist_IBF, Soll_IBF, Abschalten);
                                   
                                   //Soll_IBF->Flag.ag_mode = 2; 
                                   //Soll_IBF->Flag.ag_act = 3;
                 ...
                 case 'x':
                             ...
                             /* Betriebsart */
                             //Soll_Inter->ag_mode = Soll_IBF->Flag.ag_mode = 4; //Vorschub, Position nicht erreicht, SMS-Vorgabe
                  ...
                  case 'y': 
                    ...
                    case 'a':  /* Positionieren des Radialschlittens */	
                            ...
                            /* Geschwindigkeiten  */
                             ...
                             if(Ist_IBF->Flag.rs_kraftanfahren_aktiv != 0) //aus IBF-Para(Radv01): in Kraft anwalzen 
                               {  	
                                  /* Vorgabe: Geschwindigkeit*/
                                  Soll_IBF->RS_V  = 7.0F;                  
                                                       
                                  /* Bedingung */
                                    if( (Ist_IBF->FR) == (Soll_IBF->RS_Kraft_Vorgabe))
                                    {
                  ...
                  case 'b':   /* Positionierung des Axialgerüstes:  Vorgabe der Position */               				
                             ...
                             //Soll_IBF->Soll_ASU_V  =  0.0F;
                              ...
                              /* Betriebsmodi in case -1 gesetzt */
                              //Soll_Inter->ag_mode = Soll_IBF->Flag.ag_mode = 0; //Vorschub, Position nicht erreicht, SMS-Vorgabe
                              ...
                              Soll_IBF->AG_Pos = Soll_IBF->AG_Pos_Null;  // in case -1 gesetzte Nullposition
                  ...
                  case 'c':   /*Position Axialgerüst: Abfragen */
                              ...
                              if ( Soll_IBF->AG_Pos <= (Ist_IBF->AG_Pos_Start + eps) )
                              {
                                 if ( (Ist_IBF->AG_Pos <= (Soll_IBF->AG_Pos + eps)) || (Ist_IBF->AG_Pos >= (Soll_IBF->AG_Pos - eps)) )
                                 {
                                    Soll_IBF->AG_Pos = Ist_IBF->AG_Pos;
                  ...
                  case 'd':   /*Position Axialschlitten*/
                              ...
                              if(Ist_IBF->Flag.as_kraftanfahren_aktiv == 1) //aus IBF-Para(Radv01): in Kraft anwalzen 
                               {  	
                                  /* Vorgabe: Geschwindigkeit*/
                                  Soll_IBF->ASO_V  = 4.0F;                  
                                                       
                                  /* Bedingung */
                                    if( (Ist_IBF->FA) == (Soll_IBF->AS_Kraft_Vorgabe))
                                    {
                                        Soll_IBF->Zeit.t_Halte--; // Wenn Kraft erreicht ist soll die Zeit t ablaufen bevor der Prozess weiterläuft
                                        if(Soll_IBF->Zeit.t_Halte <= 0)
                                        {
                  ...
                  case 'z':   // 2 Umdrehungen abwarten für gleichmäßiges Profil über Umfang 
                              Soll_IBF->Zeit.t_Halte--;
                              if (Soll_IBF->Zeit.t_Halte <= 0) {Soll_IBF->InitAchse = 'b';};
                              break;  // zu case 'z'
         ...
         case 1:     // Vergleich der eingegebenen Wandstärke und der, per Kraftsteuerung angefahrenen Wandstärke
                     ...
                     //#ifdef MRAW
                     //Ist_IBF->Radial.s_f = Ist_IBF->Radial.Anfangsposition_DW - ((186.9F + Ist_IBF->Werkzeug.Durchmesser_DW)/2.0F);
                     //#endif
       ...
       case 3:    // Abschalmass erreicht Banning
                 
                  /* Funktionsaufruf */
                  //Abschaltung(Soll_IBF);
                  Soll_IBF->Flag.ag_mode = 2;
                  Soll_IBF->Flag.ag_act = 2;
                  break;
...
//########## Ende Hand- bzw. Automatiksteuerung ##########
    ...
    /* ------------------------------------------------------------------------ */
              ...
              /* Flag für Achsensteuerung */
                  Soll_Inter->ag_mode = Soll_IBF->Flag.ag_mode;
